...
var IosBuildOutline = function (_Component) {
  _inherits(IosBuildOutline, _Component);

  function IosBuildOutline(props) {
    _classCallCheck(this, IosBuildOutline);

    var _this = _possibleConstructorReturn(this, (IosBuildOutline.__proto__ || Object.getPrototypeOf(IosBuildOutline)).call(this, props));
