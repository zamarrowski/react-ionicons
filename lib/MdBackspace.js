...
var MdBackspace = function (_Component) {
  _inherits(MdBackspace, _Component);

  function MdBackspace(props) {
    _classCallCheck(this, MdBackspace);

    var _this = _possibleConstructorReturn(this, (MdBackspace.__proto__ || Object.getPrototypeOf(MdBackspace)).call(this, props));
