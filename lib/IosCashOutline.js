...
var IosCashOutline = function (_Component) {
  _inherits(IosCashOutline, _Component);

  function IosCashOutline(props) {
    _classCallCheck(this, IosCashOutline);

    var _this = _possibleConstructorReturn(this, (IosCashOutline.__proto__ || Object.getPrototypeOf(IosCashOutline)).call(this, props));
