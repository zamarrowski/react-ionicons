...
var MdReverseCamera = function (_Component) {
  _inherits(MdReverseCamera, _Component);

  function MdReverseCamera(props) {
    _classCallCheck(this, MdReverseCamera);

    var _this = _possibleConstructorReturn(this, (MdReverseCamera.__proto__ || Object.getPrototypeOf(MdReverseCamera)).call(this, props));
