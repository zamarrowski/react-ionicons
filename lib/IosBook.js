...
var IosBook = function (_Component) {
  _inherits(IosBook, _Component);

  function IosBook(props) {
    _classCallCheck(this, IosBook);

    var _this = _possibleConstructorReturn(this, (IosBook.__proto__ || Object.getPrototypeOf(IosBook)).call(this, props));
