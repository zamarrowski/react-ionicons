...
var MdMail = function (_Component) {
  _inherits(MdMail, _Component);

  function MdMail(props) {
    _classCallCheck(this, MdMail);

    var _this = _possibleConstructorReturn(this, (MdMail.__proto__ || Object.getPrototypeOf(MdMail)).call(this, props));
