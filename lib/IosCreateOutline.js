...
var IosCreateOutline = function (_Component) {
  _inherits(IosCreateOutline, _Component);

  function IosCreateOutline(props) {
    _classCallCheck(this, IosCreateOutline);

    var _this = _possibleConstructorReturn(this, (IosCreateOutline.__proto__ || Object.getPrototypeOf(IosCreateOutline)).call(this, props));
