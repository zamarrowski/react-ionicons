...
var MdWoman = function (_Component) {
  _inherits(MdWoman, _Component);

  function MdWoman(props) {
    _classCallCheck(this, MdWoman);

    var _this = _possibleConstructorReturn(this, (MdWoman.__proto__ || Object.getPrototypeOf(MdWoman)).call(this, props));
