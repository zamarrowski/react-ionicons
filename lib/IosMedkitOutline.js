...
var IosMedkitOutline = function (_Component) {
  _inherits(IosMedkitOutline, _Component);

  function IosMedkitOutline(props) {
    _classCallCheck(this, IosMedkitOutline);

    var _this = _possibleConstructorReturn(this, (IosMedkitOutline.__proto__ || Object.getPrototypeOf(IosMedkitOutline)).call(this, props));
