...
var IosTimerOutline = function (_Component) {
  _inherits(IosTimerOutline, _Component);

  function IosTimerOutline(props) {
    _classCallCheck(this, IosTimerOutline);

    var _this = _possibleConstructorReturn(this, (IosTimerOutline.__proto__ || Object.getPrototypeOf(IosTimerOutline)).call(this, props));
