...
var MdThunderstorm = function (_Component) {
  _inherits(MdThunderstorm, _Component);

  function MdThunderstorm(props) {
    _classCallCheck(this, MdThunderstorm);

    var _this = _possibleConstructorReturn(this, (MdThunderstorm.__proto__ || Object.getPrototypeOf(MdThunderstorm)).call(this, props));
