...
var MdHeadset = function (_Component) {
  _inherits(MdHeadset, _Component);

  function MdHeadset(props) {
    _classCallCheck(this, MdHeadset);

    var _this = _possibleConstructorReturn(this, (MdHeadset.__proto__ || Object.getPrototypeOf(MdHeadset)).call(this, props));
