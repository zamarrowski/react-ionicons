...
var IosImages = function (_Component) {
  _inherits(IosImages, _Component);

  function IosImages(props) {
    _classCallCheck(this, IosImages);

    var _this = _possibleConstructorReturn(this, (IosImages.__proto__ || Object.getPrototypeOf(IosImages)).call(this, props));
