...
var IosTrendingDown = function (_Component) {
  _inherits(IosTrendingDown, _Component);

  function IosTrendingDown(props) {
    _classCallCheck(this, IosTrendingDown);

    var _this = _possibleConstructorReturn(this, (IosTrendingDown.__proto__ || Object.getPrototypeOf(IosTrendingDown)).call(this, props));
