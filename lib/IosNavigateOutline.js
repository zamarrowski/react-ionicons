...
var IosNavigateOutline = function (_Component) {
  _inherits(IosNavigateOutline, _Component);

  function IosNavigateOutline(props) {
    _classCallCheck(this, IosNavigateOutline);

    var _this = _possibleConstructorReturn(this, (IosNavigateOutline.__proto__ || Object.getPrototypeOf(IosNavigateOutline)).call(this, props));
