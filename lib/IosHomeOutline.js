...
var IosHomeOutline = function (_Component) {
  _inherits(IosHomeOutline, _Component);

  function IosHomeOutline(props) {
    _classCallCheck(this, IosHomeOutline);

    var _this = _possibleConstructorReturn(this, (IosHomeOutline.__proto__ || Object.getPrototypeOf(IosHomeOutline)).call(this, props));
