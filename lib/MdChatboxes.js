...
var MdChatboxes = function (_Component) {
  _inherits(MdChatboxes, _Component);

  function MdChatboxes(props) {
    _classCallCheck(this, MdChatboxes);

    var _this = _possibleConstructorReturn(this, (MdChatboxes.__proto__ || Object.getPrototypeOf(MdChatboxes)).call(this, props));
