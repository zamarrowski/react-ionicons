...
var IosColorWandOutline = function (_Component) {
  _inherits(IosColorWandOutline, _Component);

  function IosColorWandOutline(props) {
    _classCallCheck(this, IosColorWandOutline);

    var _this = _possibleConstructorReturn(this, (IosColorWandOutline.__proto__ || Object.getPrototypeOf(IosColorWandOutline)).call(this, props));
