...
var IosPricetag = function (_Component) {
  _inherits(IosPricetag, _Component);

  function IosPricetag(props) {
    _classCallCheck(this, IosPricetag);

    var _this = _possibleConstructorReturn(this, (IosPricetag.__proto__ || Object.getPrototypeOf(IosPricetag)).call(this, props));
