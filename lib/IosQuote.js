...
var IosQuote = function (_Component) {
  _inherits(IosQuote, _Component);

  function IosQuote(props) {
    _classCallCheck(this, IosQuote);

    var _this = _possibleConstructorReturn(this, (IosQuote.__proto__ || Object.getPrototypeOf(IosQuote)).call(this, props));
