...
var IosPaperPlaneOutline = function (_Component) {
  _inherits(IosPaperPlaneOutline, _Component);

  function IosPaperPlaneOutline(props) {
    _classCallCheck(this, IosPaperPlaneOutline);

    var _this = _possibleConstructorReturn(this, (IosPaperPlaneOutline.__proto__ || Object.getPrototypeOf(IosPaperPlaneOutline)).call(this, props));
  ...
  _createClass(IosPaperPlaneOutline, [{
    key: 'render',
