...
var IosTrain = function (_Component) {
  _inherits(IosTrain, _Component);

  function IosTrain(props) {
    _classCallCheck(this, IosTrain);

    var _this = _possibleConstructorReturn(this, (IosTrain.__proto__ || Object.getPrototypeOf(IosTrain)).call(this, props));
