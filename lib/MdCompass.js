...
var MdCompass = function (_Component) {
  _inherits(MdCompass, _Component);

  function MdCompass(props) {
    _classCallCheck(this, MdCompass);

    var _this = _possibleConstructorReturn(this, (MdCompass.__proto__ || Object.getPrototypeOf(MdCompass)).call(this, props));
