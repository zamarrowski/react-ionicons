...
var MdFiling = function (_Component) {
  _inherits(MdFiling, _Component);

  function MdFiling(props) {
    _classCallCheck(this, MdFiling);

    var _this = _possibleConstructorReturn(this, (MdFiling.__proto__ || Object.getPrototypeOf(MdFiling)).call(this, props));
