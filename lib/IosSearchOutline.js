...
var IosSearchOutline = function (_Component) {
  _inherits(IosSearchOutline, _Component);

  function IosSearchOutline(props) {
    _classCallCheck(this, IosSearchOutline);

    var _this = _possibleConstructorReturn(this, (IosSearchOutline.__proto__ || Object.getPrototypeOf(IosSearchOutline)).call(this, props));
