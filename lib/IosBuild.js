...
var IosBuild = function (_Component) {
  _inherits(IosBuild, _Component);

  function IosBuild(props) {
    _classCallCheck(this, IosBuild);

    var _this = _possibleConstructorReturn(this, (IosBuild.__proto__ || Object.getPrototypeOf(IosBuild)).call(this, props));
