...
var IosBeaker = function (_Component) {
  _inherits(IosBeaker, _Component);

  function IosBeaker(props) {
    _classCallCheck(this, IosBeaker);

    var _this = _possibleConstructorReturn(this, (IosBeaker.__proto__ || Object.getPrototypeOf(IosBeaker)).call(this, props));
