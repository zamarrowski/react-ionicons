...
var IosPinOutline = function (_Component) {
  _inherits(IosPinOutline, _Component);

  function IosPinOutline(props) {
    _classCallCheck(this, IosPinOutline);

    var _this = _possibleConstructorReturn(this, (IosPinOutline.__proto__ || Object.getPrototypeOf(IosPinOutline)).call(this, props));
