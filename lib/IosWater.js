...
var IosWater = function (_Component) {
  _inherits(IosWater, _Component);

  function IosWater(props) {
    _classCallCheck(this, IosWater);

    var _this = _possibleConstructorReturn(this, (IosWater.__proto__ || Object.getPrototypeOf(IosWater)).call(this, props));
