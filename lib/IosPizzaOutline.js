...
var IosPizzaOutline = function (_Component) {
  _inherits(IosPizzaOutline, _Component);

  function IosPizzaOutline(props) {
    _classCallCheck(this, IosPizzaOutline);

    var _this = _possibleConstructorReturn(this, (IosPizzaOutline.__proto__ || Object.getPrototypeOf(IosPizzaOutline)).call(this, props));
  ...
  return IosPizzaOutline;
}(_react.Component);

IosPizzaOutline.defaultProps = {
  // style
  style: {},
  color: '#000000',
  fontSize: '22px',
...
exports.default = IosPizzaOutline;
module.exports = exports['default'];
//# sourceMappingURL=IosPizzaOutline.js.map