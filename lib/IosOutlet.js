...
var IosOutlet = function (_Component) {
  _inherits(IosOutlet, _Component);

  function IosOutlet(props) {
    _classCallCheck(this, IosOutlet);

    var _this = _possibleConstructorReturn(this, (IosOutlet.__proto__ || Object.getPrototypeOf(IosOutlet)).call(this, props));
