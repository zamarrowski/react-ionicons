...
var IosWine = function (_Component) {
  _inherits(IosWine, _Component);

  function IosWine(props) {
    _classCallCheck(this, IosWine);

    var _this = _possibleConstructorReturn(this, (IosWine.__proto__ || Object.getPrototypeOf(IosWine)).call(this, props));
