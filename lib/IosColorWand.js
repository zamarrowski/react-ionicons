...
var IosColorWand = function (_Component) {
  _inherits(IosColorWand, _Component);

  function IosColorWand(props) {
    _classCallCheck(this, IosColorWand);

    var _this = _possibleConstructorReturn(this, (IosColorWand.__proto__ || Object.getPrototypeOf(IosColorWand)).call(this, props));
