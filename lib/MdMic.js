...
var MdMic = function (_Component) {
  _inherits(MdMic, _Component);

  function MdMic(props) {
    _classCallCheck(this, MdMic);

    var _this = _possibleConstructorReturn(this, (MdMic.__proto__ || Object.getPrototypeOf(MdMic)).call(this, props));
