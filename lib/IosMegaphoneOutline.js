...
var IosMegaphoneOutline = function (_Component) {
  _inherits(IosMegaphoneOutline, _Component);

  function IosMegaphoneOutline(props) {
    _classCallCheck(this, IosMegaphoneOutline);

    var _this = _possibleConstructorReturn(this, (IosMegaphoneOutline.__proto__ || Object.getPrototypeOf(IosMegaphoneOutline)).call(this, props));
  ...
  _createClass(IosMegaphoneOutline, [{
    key: 'render',
