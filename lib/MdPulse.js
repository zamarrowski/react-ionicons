...
var MdPulse = function (_Component) {
  _inherits(MdPulse, _Component);

  function MdPulse(props) {
    _classCallCheck(this, MdPulse);

    var _this = _possibleConstructorReturn(this, (MdPulse.__proto__ || Object.getPrototypeOf(MdPulse)).call(this, props));
