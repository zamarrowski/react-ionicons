...
var IosDoneAll = function (_Component) {
  _inherits(IosDoneAll, _Component);

  function IosDoneAll(props) {
    _classCallCheck(this, IosDoneAll);

    var _this = _possibleConstructorReturn(this, (IosDoneAll.__proto__ || Object.getPrototypeOf(IosDoneAll)).call(this, props));
