...
var IosLock = function (_Component) {
  _inherits(IosLock, _Component);

  function IosLock(props) {
    _classCallCheck(this, IosLock);

    var _this = _possibleConstructorReturn(this, (IosLock.__proto__ || Object.getPrototypeOf(IosLock)).call(this, props));
