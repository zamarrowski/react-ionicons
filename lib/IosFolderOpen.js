...
var IosFolderOpen = function (_Component) {
  _inherits(IosFolderOpen, _Component);

  function IosFolderOpen(props) {
    _classCallCheck(this, IosFolderOpen);

    var _this = _possibleConstructorReturn(this, (IosFolderOpen.__proto__ || Object.getPrototypeOf(IosFolderOpen)).call(this, props));
