...
var MdCheckboxOutline = function (_Component) {
  _inherits(MdCheckboxOutline, _Component);

  function MdCheckboxOutline(props) {
    _classCallCheck(this, MdCheckboxOutline);

    var _this = _possibleConstructorReturn(this, (MdCheckboxOutline.__proto__ || Object.getPrototypeOf(MdCheckboxOutline)).call(this, props));
  ...
  _createClass(MdCheckboxOutline, [{
    key: 'render',
