...
var MdCheckmarkCircleOutline = function (_Component) {
  _inherits(MdCheckmarkCircleOutline, _Component);

  function MdCheckmarkCircleOutline(props) {
    _classCallCheck(this, MdCheckmarkCircleOutline);

    var _this = _possibleConstructorReturn(this, (MdCheckmarkCircleOutline.__proto__ || Object.getPrototypeOf(MdCheckmarkCircleOutline)).call(this, props));
  ...
  _createClass(MdCheckmarkCircleOutline, [{
    key: 'render',
