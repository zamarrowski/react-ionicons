...
var IosBasket = function (_Component) {
  _inherits(IosBasket, _Component);

  function IosBasket(props) {
    _classCallCheck(this, IosBasket);

    var _this = _possibleConstructorReturn(this, (IosBasket.__proto__ || Object.getPrototypeOf(IosBasket)).call(this, props));
