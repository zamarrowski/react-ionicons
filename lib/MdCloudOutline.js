...
var MdCloudOutline = function (_Component) {
  _inherits(MdCloudOutline, _Component);

  function MdCloudOutline(props) {
    _classCallCheck(this, MdCloudOutline);

    var _this = _possibleConstructorReturn(this, (MdCloudOutline.__proto__ || Object.getPrototypeOf(MdCloudOutline)).call(this, props));
