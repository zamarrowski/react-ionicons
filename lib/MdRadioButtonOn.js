...
var MdRadioButtonOn = function (_Component) {
  _inherits(MdRadioButtonOn, _Component);

  function MdRadioButtonOn(props) {
    _classCallCheck(this, MdRadioButtonOn);

    var _this = _possibleConstructorReturn(this, (MdRadioButtonOn.__proto__ || Object.getPrototypeOf(MdRadioButtonOn)).call(this, props));
