...
var MdColorWand = function (_Component) {
  _inherits(MdColorWand, _Component);

  function MdColorWand(props) {
    _classCallCheck(this, MdColorWand);

    var _this = _possibleConstructorReturn(this, (MdColorWand.__proto__ || Object.getPrototypeOf(MdColorWand)).call(this, props));
