...
var IosPricetagsOutline = function (_Component) {
  _inherits(IosPricetagsOutline, _Component);

  function IosPricetagsOutline(props) {
    _classCallCheck(this, IosPricetagsOutline);

    var _this = _possibleConstructorReturn(this, (IosPricetagsOutline.__proto__ || Object.getPrototypeOf(IosPricetagsOutline)).call(this, props));
