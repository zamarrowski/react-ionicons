...
var MdOutlet = function (_Component) {
  _inherits(MdOutlet, _Component);

  function MdOutlet(props) {
    _classCallCheck(this, MdOutlet);

    var _this = _possibleConstructorReturn(this, (MdOutlet.__proto__ || Object.getPrototypeOf(MdOutlet)).call(this, props));
