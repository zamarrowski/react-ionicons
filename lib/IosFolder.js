...
var IosFolder = function (_Component) {
  _inherits(IosFolder, _Component);

  function IosFolder(props) {
    _classCallCheck(this, IosFolder);

    var _this = _possibleConstructorReturn(this, (IosFolder.__proto__ || Object.getPrototypeOf(IosFolder)).call(this, props));
