...
var IosAppstore = function (_Component) {
  _inherits(IosAppstore, _Component);

  function IosAppstore(props) {
    _classCallCheck(this, IosAppstore);

    var _this = _possibleConstructorReturn(this, (IosAppstore.__proto__ || Object.getPrototypeOf(IosAppstore)).call(this, props));
