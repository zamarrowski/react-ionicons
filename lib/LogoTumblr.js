...
var LogoTumblr = function (_Component) {
  _inherits(LogoTumblr, _Component);

  function LogoTumblr(props) {
    _classCallCheck(this, LogoTumblr);

    var _this = _possibleConstructorReturn(this, (LogoTumblr.__proto__ || Object.getPrototypeOf(LogoTumblr)).call(this, props));
