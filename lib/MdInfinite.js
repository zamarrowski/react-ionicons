...
var MdInfinite = function (_Component) {
  _inherits(MdInfinite, _Component);

  function MdInfinite(props) {
    _classCallCheck(this, MdInfinite);

    var _this = _possibleConstructorReturn(this, (MdInfinite.__proto__ || Object.getPrototypeOf(MdInfinite)).call(this, props));
