...
var IosMoon = function (_Component) {
  _inherits(IosMoon, _Component);

  function IosMoon(props) {
    _classCallCheck(this, IosMoon);

    var _this = _possibleConstructorReturn(this, (IosMoon.__proto__ || Object.getPrototypeOf(IosMoon)).call(this, props));
