...
var MdBowtie = function (_Component) {
  _inherits(MdBowtie, _Component);

  function MdBowtie(props) {
    _classCallCheck(this, MdBowtie);

    var _this = _possibleConstructorReturn(this, (MdBowtie.__proto__ || Object.getPrototypeOf(MdBowtie)).call(this, props));
