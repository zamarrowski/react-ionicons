...
var IosTrophyOutline = function (_Component) {
  _inherits(IosTrophyOutline, _Component);

  function IosTrophyOutline(props) {
    _classCallCheck(this, IosTrophyOutline);

    var _this = _possibleConstructorReturn(this, (IosTrophyOutline.__proto__ || Object.getPrototypeOf(IosTrophyOutline)).call(this, props));
