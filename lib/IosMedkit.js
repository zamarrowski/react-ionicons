...
var IosMedkit = function (_Component) {
  _inherits(IosMedkit, _Component);

  function IosMedkit(props) {
    _classCallCheck(this, IosMedkit);

    var _this = _possibleConstructorReturn(this, (IosMedkit.__proto__ || Object.getPrototypeOf(IosMedkit)).call(this, props));
