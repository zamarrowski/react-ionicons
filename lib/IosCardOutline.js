...
var IosCardOutline = function (_Component) {
  _inherits(IosCardOutline, _Component);

  function IosCardOutline(props) {
    _classCallCheck(this, IosCardOutline);

    var _this = _possibleConstructorReturn(this, (IosCardOutline.__proto__ || Object.getPrototypeOf(IosCardOutline)).call(this, props));
