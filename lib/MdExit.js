...
var MdExit = function (_Component) {
  _inherits(MdExit, _Component);

  function MdExit(props) {
    _classCallCheck(this, MdExit);

    var _this = _possibleConstructorReturn(this, (MdExit.__proto__ || Object.getPrototypeOf(MdExit)).call(this, props));
