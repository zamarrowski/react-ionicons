...
var MdFlask = function (_Component) {
  _inherits(MdFlask, _Component);

  function MdFlask(props) {
    _classCallCheck(this, MdFlask);

    var _this = _possibleConstructorReturn(this, (MdFlask.__proto__ || Object.getPrototypeOf(MdFlask)).call(this, props));
