...
var IosQrScanner = function (_Component) {
  _inherits(IosQrScanner, _Component);

  function IosQrScanner(props) {
    _classCallCheck(this, IosQrScanner);

    var _this = _possibleConstructorReturn(this, (IosQrScanner.__proto__ || Object.getPrototypeOf(IosQrScanner)).call(this, props));
