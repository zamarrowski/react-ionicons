...
var IosShirt = function (_Component) {
  _inherits(IosShirt, _Component);

  function IosShirt(props) {
    _classCallCheck(this, IosShirt);

    var _this = _possibleConstructorReturn(this, (IosShirt.__proto__ || Object.getPrototypeOf(IosShirt)).call(this, props));
