...
var MdGitMerge = function (_Component) {
  _inherits(MdGitMerge, _Component);

  function MdGitMerge(props) {
    _classCallCheck(this, MdGitMerge);

    var _this = _possibleConstructorReturn(this, (MdGitMerge.__proto__ || Object.getPrototypeOf(MdGitMerge)).call(this, props));
