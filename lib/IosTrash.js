...
var IosTrash = function (_Component) {
  _inherits(IosTrash, _Component);

  function IosTrash(props) {
    _classCallCheck(this, IosTrash);

    var _this = _possibleConstructorReturn(this, (IosTrash.__proto__ || Object.getPrototypeOf(IosTrash)).call(this, props));
