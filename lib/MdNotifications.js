...
var MdNotifications = function (_Component) {
  _inherits(MdNotifications, _Component);

  function MdNotifications(props) {
    _classCallCheck(this, MdNotifications);

    var _this = _possibleConstructorReturn(this, (MdNotifications.__proto__ || Object.getPrototypeOf(MdNotifications)).call(this, props));
