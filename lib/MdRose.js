...
var MdRose = function (_Component) {
  _inherits(MdRose, _Component);

  function MdRose(props) {
    _classCallCheck(this, MdRose);

    var _this = _possibleConstructorReturn(this, (MdRose.__proto__ || Object.getPrototypeOf(MdRose)).call(this, props));
