...
var LogoAndroid = function (_Component) {
  _inherits(LogoAndroid, _Component);

  function LogoAndroid(props) {
    _classCallCheck(this, LogoAndroid);

    var _this = _possibleConstructorReturn(this, (LogoAndroid.__proto__ || Object.getPrototypeOf(LogoAndroid)).call(this, props));
