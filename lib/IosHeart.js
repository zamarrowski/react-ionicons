...
var IosHeart = function (_Component) {
  _inherits(IosHeart, _Component);

  function IosHeart(props) {
    _classCallCheck(this, IosHeart);

    var _this = _possibleConstructorReturn(this, (IosHeart.__proto__ || Object.getPrototypeOf(IosHeart)).call(this, props));
