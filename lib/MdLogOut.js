...
var MdLogOut = function (_Component) {
  _inherits(MdLogOut, _Component);

  function MdLogOut(props) {
    _classCallCheck(this, MdLogOut);

    var _this = _possibleConstructorReturn(this, (MdLogOut.__proto__ || Object.getPrototypeOf(MdLogOut)).call(this, props));
