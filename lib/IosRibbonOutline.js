...
var IosRibbonOutline = function (_Component) {
  _inherits(IosRibbonOutline, _Component);

  function IosRibbonOutline(props) {
    _classCallCheck(this, IosRibbonOutline);

    var _this = _possibleConstructorReturn(this, (IosRibbonOutline.__proto__ || Object.getPrototypeOf(IosRibbonOutline)).call(this, props));
