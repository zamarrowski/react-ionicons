...
var MdChatbubbles = function (_Component) {
  _inherits(MdChatbubbles, _Component);

  function MdChatbubbles(props) {
    _classCallCheck(this, MdChatbubbles);

    var _this = _possibleConstructorReturn(this, (MdChatbubbles.__proto__ || Object.getPrototypeOf(MdChatbubbles)).call(this, props));
