...
var LogoGoogleplus = function (_Component) {
  _inherits(LogoGoogleplus, _Component);

  function LogoGoogleplus(props) {
    _classCallCheck(this, LogoGoogleplus);

    var _this = _possibleConstructorReturn(this, (LogoGoogleplus.__proto__ || Object.getPrototypeOf(LogoGoogleplus)).call(this, props));
