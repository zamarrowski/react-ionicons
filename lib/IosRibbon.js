...
var IosRibbon = function (_Component) {
  _inherits(IosRibbon, _Component);

  function IosRibbon(props) {
    _classCallCheck(this, IosRibbon);

    var _this = _possibleConstructorReturn(this, (IosRibbon.__proto__ || Object.getPrototypeOf(IosRibbon)).call(this, props));
