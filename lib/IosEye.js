...
var IosEye = function (_Component) {
  _inherits(IosEye, _Component);

  function IosEye(props) {
    _classCallCheck(this, IosEye);

    var _this = _possibleConstructorReturn(this, (IosEye.__proto__ || Object.getPrototypeOf(IosEye)).call(this, props));
