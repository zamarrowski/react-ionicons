...
var MdJet = function (_Component) {
  _inherits(MdJet, _Component);

  function MdJet(props) {
    _classCallCheck(this, MdJet);

    var _this = _possibleConstructorReturn(this, (MdJet.__proto__ || Object.getPrototypeOf(MdJet)).call(this, props));
