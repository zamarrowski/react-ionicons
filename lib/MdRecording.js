...
var MdRecording = function (_Component) {
  _inherits(MdRecording, _Component);

  function MdRecording(props) {
    _classCallCheck(this, MdRecording);

    var _this = _possibleConstructorReturn(this, (MdRecording.__proto__ || Object.getPrototypeOf(MdRecording)).call(this, props));
