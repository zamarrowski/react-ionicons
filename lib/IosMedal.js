...
var IosMedal = function (_Component) {
  _inherits(IosMedal, _Component);

  function IosMedal(props) {
    _classCallCheck(this, IosMedal);

    var _this = _possibleConstructorReturn(this, (IosMedal.__proto__ || Object.getPrototypeOf(IosMedal)).call(this, props));
