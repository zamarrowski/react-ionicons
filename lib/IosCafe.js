...
var IosCafe = function (_Component) {
  _inherits(IosCafe, _Component);

  function IosCafe(props) {
    _classCallCheck(this, IosCafe);

    var _this = _possibleConstructorReturn(this, (IosCafe.__proto__ || Object.getPrototypeOf(IosCafe)).call(this, props));
