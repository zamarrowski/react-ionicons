...
var IosMore = function (_Component) {
  _inherits(IosMore, _Component);

  function IosMore(props) {
    _classCallCheck(this, IosMore);

    var _this = _possibleConstructorReturn(this, (IosMore.__proto__ || Object.getPrototypeOf(IosMore)).call(this, props));
