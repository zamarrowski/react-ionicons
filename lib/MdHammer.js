...
var MdHammer = function (_Component) {
  _inherits(MdHammer, _Component);

  function MdHammer(props) {
    _classCallCheck(this, MdHammer);

    var _this = _possibleConstructorReturn(this, (MdHammer.__proto__ || Object.getPrototypeOf(MdHammer)).call(this, props));
