...
var IosPhonePortrait = function (_Component) {
  _inherits(IosPhonePortrait, _Component);

  function IosPhonePortrait(props) {
    _classCallCheck(this, IosPhonePortrait);

    var _this = _possibleConstructorReturn(this, (IosPhonePortrait.__proto__ || Object.getPrototypeOf(IosPhonePortrait)).call(this, props));
