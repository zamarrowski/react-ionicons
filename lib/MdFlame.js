...
var MdFlame = function (_Component) {
  _inherits(MdFlame, _Component);

  function MdFlame(props) {
    _classCallCheck(this, MdFlame);

    var _this = _possibleConstructorReturn(this, (MdFlame.__proto__ || Object.getPrototypeOf(MdFlame)).call(this, props));
