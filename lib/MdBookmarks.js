...
var MdBookmarks = function (_Component) {
  _inherits(MdBookmarks, _Component);

  function MdBookmarks(props) {
    _classCallCheck(this, MdBookmarks);

    var _this = _possibleConstructorReturn(this, (MdBookmarks.__proto__ || Object.getPrototypeOf(MdBookmarks)).call(this, props));
