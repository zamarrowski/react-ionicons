...
var MdClipboard = function (_Component) {
  _inherits(MdClipboard, _Component);

  function MdClipboard(props) {
    _classCallCheck(this, MdClipboard);

    var _this = _possibleConstructorReturn(this, (MdClipboard.__proto__ || Object.getPrototypeOf(MdClipboard)).call(this, props));
