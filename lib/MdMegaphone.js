...
var MdMegaphone = function (_Component) {
  _inherits(MdMegaphone, _Component);

  function MdMegaphone(props) {
    _classCallCheck(this, MdMegaphone);

    var _this = _possibleConstructorReturn(this, (MdMegaphone.__proto__ || Object.getPrototypeOf(MdMegaphone)).call(this, props));
