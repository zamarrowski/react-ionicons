...
var MdCloudCircle = function (_Component) {
  _inherits(MdCloudCircle, _Component);

  function MdCloudCircle(props) {
    _classCallCheck(this, MdCloudCircle);

    var _this = _possibleConstructorReturn(this, (MdCloudCircle.__proto__ || Object.getPrototypeOf(MdCloudCircle)).call(this, props));
