...
var MdCodeWorking = function (_Component) {
  _inherits(MdCodeWorking, _Component);

  function MdCodeWorking(props) {
    _classCallCheck(this, MdCodeWorking);

    var _this = _possibleConstructorReturn(this, (MdCodeWorking.__proto__ || Object.getPrototypeOf(MdCodeWorking)).call(this, props));
