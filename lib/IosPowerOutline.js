...
var IosPowerOutline = function (_Component) {
  _inherits(IosPowerOutline, _Component);

  function IosPowerOutline(props) {
    _classCallCheck(this, IosPowerOutline);

    var _this = _possibleConstructorReturn(this, (IosPowerOutline.__proto__ || Object.getPrototypeOf(IosPowerOutline)).call(this, props));
