...
var IosJet = function (_Component) {
  _inherits(IosJet, _Component);

  function IosJet(props) {
    _classCallCheck(this, IosJet);

    var _this = _possibleConstructorReturn(this, (IosJet.__proto__ || Object.getPrototypeOf(IosJet)).call(this, props));
