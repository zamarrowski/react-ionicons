...
var IosUndo = function (_Component) {
  _inherits(IosUndo, _Component);

  function IosUndo(props) {
    _classCallCheck(this, IosUndo);

    var _this = _possibleConstructorReturn(this, (IosUndo.__proto__ || Object.getPrototypeOf(IosUndo)).call(this, props));
