...
var IosSunny = function (_Component) {
  _inherits(IosSunny, _Component);

  function IosSunny(props) {
    _classCallCheck(this, IosSunny);

    var _this = _possibleConstructorReturn(this, (IosSunny.__proto__ || Object.getPrototypeOf(IosSunny)).call(this, props));
