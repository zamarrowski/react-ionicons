...
var MdBus = function (_Component) {
  _inherits(MdBus, _Component);

  function MdBus(props) {
    _classCallCheck(this, MdBus);

    var _this = _possibleConstructorReturn(this, (MdBus.__proto__ || Object.getPrototypeOf(MdBus)).call(this, props));
