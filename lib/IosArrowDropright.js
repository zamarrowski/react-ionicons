...
var IosArrowDropright = function (_Component) {
  _inherits(IosArrowDropright, _Component);

  function IosArrowDropright(props) {
    _classCallCheck(this, IosArrowDropright);

    var _this = _possibleConstructorReturn(this, (IosArrowDropright.__proto__ || Object.getPrototypeOf(IosArrowDropright)).call(this, props));
  ...
  _createClass(IosArrowDropright, [{
    key: 'render',
