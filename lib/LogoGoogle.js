...
var LogoGoogle = function (_Component) {
  _inherits(LogoGoogle, _Component);

  function LogoGoogle(props) {
    _classCallCheck(this, LogoGoogle);

    var _this = _possibleConstructorReturn(this, (LogoGoogle.__proto__ || Object.getPrototypeOf(LogoGoogle)).call(this, props));
