...
var IosHelpCircleOutline = function (_Component) {
  _inherits(IosHelpCircleOutline, _Component);

  function IosHelpCircleOutline(props) {
    _classCallCheck(this, IosHelpCircleOutline);

    var _this = _possibleConstructorReturn(this, (IosHelpCircleOutline.__proto__ || Object.getPrototypeOf(IosHelpCircleOutline)).call(this, props));
  ...
  _createClass(IosHelpCircleOutline, [{
    key: 'render',
