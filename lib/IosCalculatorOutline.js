...
var IosCalculatorOutline = function (_Component) {
  _inherits(IosCalculatorOutline, _Component);

  function IosCalculatorOutline(props) {
    _classCallCheck(this, IosCalculatorOutline);

    var _this = _possibleConstructorReturn(this, (IosCalculatorOutline.__proto__ || Object.getPrototypeOf(IosCalculatorOutline)).call(this, props));
