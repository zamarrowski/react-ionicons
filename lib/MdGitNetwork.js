...
var MdGitNetwork = function (_Component) {
  _inherits(MdGitNetwork, _Component);

  function MdGitNetwork(props) {
    _classCallCheck(this, MdGitNetwork);

    var _this = _possibleConstructorReturn(this, (MdGitNetwork.__proto__ || Object.getPrototypeOf(MdGitNetwork)).call(this, props));
