...
var IosFlame = function (_Component) {
  _inherits(IosFlame, _Component);

  function IosFlame(props) {
    _classCallCheck(this, IosFlame);

    var _this = _possibleConstructorReturn(this, (IosFlame.__proto__ || Object.getPrototypeOf(IosFlame)).call(this, props));
