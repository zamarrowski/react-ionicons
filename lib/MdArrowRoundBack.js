...
var MdArrowRoundBack = function (_Component) {
  _inherits(MdArrowRoundBack, _Component);

  function MdArrowRoundBack(props) {
    _classCallCheck(this, MdArrowRoundBack);

    var _this = _possibleConstructorReturn(this, (MdArrowRoundBack.__proto__ || Object.getPrototypeOf(MdArrowRoundBack)).call(this, props));
