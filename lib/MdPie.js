...
var MdPie = function (_Component) {
  _inherits(MdPie, _Component);

  function MdPie(props) {
    _classCallCheck(this, MdPie);

    var _this = _possibleConstructorReturn(this, (MdPie.__proto__ || Object.getPrototypeOf(MdPie)).call(this, props));
