...
var MdCloudy = function (_Component) {
  _inherits(MdCloudy, _Component);

  function MdCloudy(props) {
    _classCallCheck(this, MdCloudy);

    var _this = _possibleConstructorReturn(this, (MdCloudy.__proto__ || Object.getPrototypeOf(MdCloudy)).call(this, props));
