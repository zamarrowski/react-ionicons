...
var MdSad = function (_Component) {
  _inherits(MdSad, _Component);

  function MdSad(props) {
    _classCallCheck(this, MdSad);

    var _this = _possibleConstructorReturn(this, (MdSad.__proto__ || Object.getPrototypeOf(MdSad)).call(this, props));
