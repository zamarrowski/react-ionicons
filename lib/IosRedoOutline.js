...
var IosRedoOutline = function (_Component) {
  _inherits(IosRedoOutline, _Component);

  function IosRedoOutline(props) {
    _classCallCheck(this, IosRedoOutline);

    var _this = _possibleConstructorReturn(this, (IosRedoOutline.__proto__ || Object.getPrototypeOf(IosRedoOutline)).call(this, props));
