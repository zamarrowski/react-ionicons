...
var MdBook = function (_Component) {
  _inherits(MdBook, _Component);

  function MdBook(props) {
    _classCallCheck(this, MdBook);

    var _this = _possibleConstructorReturn(this, (MdBook.__proto__ || Object.getPrototypeOf(MdBook)).call(this, props));
