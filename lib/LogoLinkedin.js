...
var LogoLinkedin = function (_Component) {
  _inherits(LogoLinkedin, _Component);

  function LogoLinkedin(props) {
    _classCallCheck(this, LogoLinkedin);

    var _this = _possibleConstructorReturn(this, (LogoLinkedin.__proto__ || Object.getPrototypeOf(LogoLinkedin)).call(this, props));
