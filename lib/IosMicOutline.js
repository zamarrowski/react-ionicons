...
var IosMicOutline = function (_Component) {
  _inherits(IosMicOutline, _Component);

  function IosMicOutline(props) {
    _classCallCheck(this, IosMicOutline);

    var _this = _possibleConstructorReturn(this, (IosMicOutline.__proto__ || Object.getPrototypeOf(IosMicOutline)).call(this, props));
