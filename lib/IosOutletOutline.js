...
var IosOutletOutline = function (_Component) {
  _inherits(IosOutletOutline, _Component);

  function IosOutletOutline(props) {
    _classCallCheck(this, IosOutletOutline);

    var _this = _possibleConstructorReturn(this, (IosOutletOutline.__proto__ || Object.getPrototypeOf(IosOutletOutline)).call(this, props));
