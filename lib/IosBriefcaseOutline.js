...
var IosBriefcaseOutline = function (_Component) {
  _inherits(IosBriefcaseOutline, _Component);

  function IosBriefcaseOutline(props) {
    _classCallCheck(this, IosBriefcaseOutline);

    var _this = _possibleConstructorReturn(this, (IosBriefcaseOutline.__proto__ || Object.getPrototypeOf(IosBriefcaseOutline)).call(this, props));
