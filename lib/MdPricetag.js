...
var MdPricetag = function (_Component) {
  _inherits(MdPricetag, _Component);

  function MdPricetag(props) {
    _classCallCheck(this, MdPricetag);

    var _this = _possibleConstructorReturn(this, (MdPricetag.__proto__ || Object.getPrototypeOf(MdPricetag)).call(this, props));
