...
var MdStarOutline = function (_Component) {
  _inherits(MdStarOutline, _Component);

  function MdStarOutline(props) {
    _classCallCheck(this, MdStarOutline);

    var _this = _possibleConstructorReturn(this, (MdStarOutline.__proto__ || Object.getPrototypeOf(MdStarOutline)).call(this, props));
