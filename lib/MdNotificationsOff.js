...
var MdNotificationsOff = function (_Component) {
  _inherits(MdNotificationsOff, _Component);

  function MdNotificationsOff(props) {
    _classCallCheck(this, MdNotificationsOff);

    var _this = _possibleConstructorReturn(this, (MdNotificationsOff.__proto__ || Object.getPrototypeOf(MdNotificationsOff)).call(this, props));
