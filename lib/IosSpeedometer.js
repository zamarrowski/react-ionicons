...
var IosSpeedometer = function (_Component) {
  _inherits(IosSpeedometer, _Component);

  function IosSpeedometer(props) {
    _classCallCheck(this, IosSpeedometer);

    var _this = _possibleConstructorReturn(this, (IosSpeedometer.__proto__ || Object.getPrototypeOf(IosSpeedometer)).call(this, props));
