...
var IosPaperOutline = function (_Component) {
  _inherits(IosPaperOutline, _Component);

  function IosPaperOutline(props) {
    _classCallCheck(this, IosPaperOutline);

    var _this = _possibleConstructorReturn(this, (IosPaperOutline.__proto__ || Object.getPrototypeOf(IosPaperOutline)).call(this, props));
