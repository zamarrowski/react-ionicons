...
var IosRestaurant = function (_Component) {
  _inherits(IosRestaurant, _Component);

  function IosRestaurant(props) {
    _classCallCheck(this, IosRestaurant);

    var _this = _possibleConstructorReturn(this, (IosRestaurant.__proto__ || Object.getPrototypeOf(IosRestaurant)).call(this, props));
