...
var IosVolumeOff = function (_Component) {
  _inherits(IosVolumeOff, _Component);

  function IosVolumeOff(props) {
    _classCallCheck(this, IosVolumeOff);

    var _this = _possibleConstructorReturn(this, (IosVolumeOff.__proto__ || Object.getPrototypeOf(IosVolumeOff)).call(this, props));
