...
var MdCar = function (_Component) {
  _inherits(MdCar, _Component);

  function MdCar(props) {
    _classCallCheck(this, MdCar);

    var _this = _possibleConstructorReturn(this, (MdCar.__proto__ || Object.getPrototypeOf(MdCar)).call(this, props));
