...
var IosRefreshCircleOutline = function (_Component) {
  _inherits(IosRefreshCircleOutline, _Component);

  function IosRefreshCircleOutline(props) {
    _classCallCheck(this, IosRefreshCircleOutline);

    var _this = _possibleConstructorReturn(this, (IosRefreshCircleOutline.__proto__ || Object.getPrototypeOf(IosRefreshCircleOutline)).call(this, props));
  ...
  _createClass(IosRefreshCircleOutline, [{
    key: 'render',
  ...
  return IosRefreshCircleOutline;
}(_react.Component);
