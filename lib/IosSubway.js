...
var IosSubway = function (_Component) {
  _inherits(IosSubway, _Component);

  function IosSubway(props) {
    _classCallCheck(this, IosSubway);

    var _this = _possibleConstructorReturn(this, (IosSubway.__proto__ || Object.getPrototypeOf(IosSubway)).call(this, props));
