...
var MdOptions = function (_Component) {
  _inherits(MdOptions, _Component);

  function MdOptions(props) {
    _classCallCheck(this, MdOptions);

    var _this = _possibleConstructorReturn(this, (MdOptions.__proto__ || Object.getPrototypeOf(MdOptions)).call(this, props));
