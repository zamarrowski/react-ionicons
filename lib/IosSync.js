...
var IosSync = function (_Component) {
  _inherits(IosSync, _Component);

  function IosSync(props) {
    _classCallCheck(this, IosSync);

    var _this = _possibleConstructorReturn(this, (IosSync.__proto__ || Object.getPrototypeOf(IosSync)).call(this, props));
