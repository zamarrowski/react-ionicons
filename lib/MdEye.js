...
var MdEye = function (_Component) {
  _inherits(MdEye, _Component);

  function MdEye(props) {
    _classCallCheck(this, MdEye);

    var _this = _possibleConstructorReturn(this, (MdEye.__proto__ || Object.getPrototypeOf(MdEye)).call(this, props));
