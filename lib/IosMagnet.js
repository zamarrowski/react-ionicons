...
var IosMagnet = function (_Component) {
  _inherits(IosMagnet, _Component);

  function IosMagnet(props) {
    _classCallCheck(this, IosMagnet);

    var _this = _possibleConstructorReturn(this, (IosMagnet.__proto__ || Object.getPrototypeOf(IosMagnet)).call(this, props));
