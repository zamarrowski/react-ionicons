...
var IosBasketballOutline = function (_Component) {
  _inherits(IosBasketballOutline, _Component);

  function IosBasketballOutline(props) {
    _classCallCheck(this, IosBasketballOutline);

    var _this = _possibleConstructorReturn(this, (IosBasketballOutline.__proto__ || Object.getPrototypeOf(IosBasketballOutline)).call(this, props));
  ...
  _createClass(IosBasketballOutline, [{
    key: 'render',
