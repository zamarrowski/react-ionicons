...
var IosEaselOutline = function (_Component) {
  _inherits(IosEaselOutline, _Component);

  function IosEaselOutline(props) {
    _classCallCheck(this, IosEaselOutline);

    var _this = _possibleConstructorReturn(this, (IosEaselOutline.__proto__ || Object.getPrototypeOf(IosEaselOutline)).call(this, props));
