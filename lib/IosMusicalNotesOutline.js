...
var IosMusicalNotesOutline = function (_Component) {
  _inherits(IosMusicalNotesOutline, _Component);

  function IosMusicalNotesOutline(props) {
    _classCallCheck(this, IosMusicalNotesOutline);

    var _this = _possibleConstructorReturn(this, (IosMusicalNotesOutline.__proto__ || Object.getPrototypeOf(IosMusicalNotesOutline)).call(this, props));
  ...
  _createClass(IosMusicalNotesOutline, [{
    key: 'render',
