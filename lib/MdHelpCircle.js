...
var MdHelpCircle = function (_Component) {
  _inherits(MdHelpCircle, _Component);

  function MdHelpCircle(props) {
    _classCallCheck(this, MdHelpCircle);

    var _this = _possibleConstructorReturn(this, (MdHelpCircle.__proto__ || Object.getPrototypeOf(MdHelpCircle)).call(this, props));
