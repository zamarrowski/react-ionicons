...
var MdLocate = function (_Component) {
  _inherits(MdLocate, _Component);

  function MdLocate(props) {
    _classCallCheck(this, MdLocate);

    var _this = _possibleConstructorReturn(this, (MdLocate.__proto__ || Object.getPrototypeOf(MdLocate)).call(this, props));
