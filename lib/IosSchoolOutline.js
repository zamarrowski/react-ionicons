...
var IosSchoolOutline = function (_Component) {
  _inherits(IosSchoolOutline, _Component);

  function IosSchoolOutline(props) {
    _classCallCheck(this, IosSchoolOutline);

    var _this = _possibleConstructorReturn(this, (IosSchoolOutline.__proto__ || Object.getPrototypeOf(IosSchoolOutline)).call(this, props));
