...
var LogoDesignernews = function (_Component) {
  _inherits(LogoDesignernews, _Component);

  function LogoDesignernews(props) {
    _classCallCheck(this, LogoDesignernews);

    var _this = _possibleConstructorReturn(this, (LogoDesignernews.__proto__ || Object.getPrototypeOf(LogoDesignernews)).call(this, props));
