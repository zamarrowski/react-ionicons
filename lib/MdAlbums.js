...
var MdAlbums = function (_Component) {
  _inherits(MdAlbums, _Component);

  function MdAlbums(props) {
    _classCallCheck(this, MdAlbums);

    var _this = _possibleConstructorReturn(this, (MdAlbums.__proto__ || Object.getPrototypeOf(MdAlbums)).call(this, props));
