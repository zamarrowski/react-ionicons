...
var MdPeople = function (_Component) {
  _inherits(MdPeople, _Component);

  function MdPeople(props) {
    _classCallCheck(this, MdPeople);

    var _this = _possibleConstructorReturn(this, (MdPeople.__proto__ || Object.getPrototypeOf(MdPeople)).call(this, props));
