...
var LogoYahoo = function (_Component) {
  _inherits(LogoYahoo, _Component);

  function LogoYahoo(props) {
    _classCallCheck(this, LogoYahoo);

    var _this = _possibleConstructorReturn(this, (LogoYahoo.__proto__ || Object.getPrototypeOf(LogoYahoo)).call(this, props));
