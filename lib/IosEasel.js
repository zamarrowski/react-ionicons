...
var IosEasel = function (_Component) {
  _inherits(IosEasel, _Component);

  function IosEasel(props) {
    _classCallCheck(this, IosEasel);

    var _this = _possibleConstructorReturn(this, (IosEasel.__proto__ || Object.getPrototypeOf(IosEasel)).call(this, props));
