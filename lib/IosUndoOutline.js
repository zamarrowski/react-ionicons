...
var IosUndoOutline = function (_Component) {
  _inherits(IosUndoOutline, _Component);

  function IosUndoOutline(props) {
    _classCallCheck(this, IosUndoOutline);

    var _this = _possibleConstructorReturn(this, (IosUndoOutline.__proto__ || Object.getPrototypeOf(IosUndoOutline)).call(this, props));
