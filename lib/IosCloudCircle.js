...
var IosCloudCircle = function (_Component) {
  _inherits(IosCloudCircle, _Component);

  function IosCloudCircle(props) {
    _classCallCheck(this, IosCloudCircle);

    var _this = _possibleConstructorReturn(this, (IosCloudCircle.__proto__ || Object.getPrototypeOf(IosCloudCircle)).call(this, props));
