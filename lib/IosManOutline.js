...
var IosManOutline = function (_Component) {
  _inherits(IosManOutline, _Component);

  function IosManOutline(props) {
    _classCallCheck(this, IosManOutline);

    var _this = _possibleConstructorReturn(this, (IosManOutline.__proto__ || Object.getPrototypeOf(IosManOutline)).call(this, props));
