...
var IosCloudDone = function (_Component) {
  _inherits(IosCloudDone, _Component);

  function IosCloudDone(props) {
    _classCallCheck(this, IosCloudDone);

    var _this = _possibleConstructorReturn(this, (IosCloudDone.__proto__ || Object.getPrototypeOf(IosCloudDone)).call(this, props));
