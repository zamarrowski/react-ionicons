...
var IosShareAltOutline = function (_Component) {
  _inherits(IosShareAltOutline, _Component);

  function IosShareAltOutline(props) {
    _classCallCheck(this, IosShareAltOutline);

    var _this = _possibleConstructorReturn(this, (IosShareAltOutline.__proto__ || Object.getPrototypeOf(IosShareAltOutline)).call(this, props));
  ...
  _createClass(IosShareAltOutline, [{
    key: 'render',
