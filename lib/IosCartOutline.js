...
var IosCartOutline = function (_Component) {
  _inherits(IosCartOutline, _Component);

  function IosCartOutline(props) {
    _classCallCheck(this, IosCartOutline);

    var _this = _possibleConstructorReturn(this, (IosCartOutline.__proto__ || Object.getPrototypeOf(IosCartOutline)).call(this, props));
