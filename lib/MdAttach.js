...
var MdAttach = function (_Component) {
  _inherits(MdAttach, _Component);

  function MdAttach(props) {
    _classCallCheck(this, MdAttach);

    var _this = _possibleConstructorReturn(this, (MdAttach.__proto__ || Object.getPrototypeOf(MdAttach)).call(this, props));
