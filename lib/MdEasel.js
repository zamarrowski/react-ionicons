...
var MdEasel = function (_Component) {
  _inherits(MdEasel, _Component);

  function MdEasel(props) {
    _classCallCheck(this, MdEasel);

    var _this = _possibleConstructorReturn(this, (MdEasel.__proto__ || Object.getPrototypeOf(MdEasel)).call(this, props));
