...
var IosContact = function (_Component) {
  _inherits(IosContact, _Component);

  function IosContact(props) {
    _classCallCheck(this, IosContact);

    var _this = _possibleConstructorReturn(this, (IosContact.__proto__ || Object.getPrototypeOf(IosContact)).call(this, props));
