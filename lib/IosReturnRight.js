...
var IosReturnRight = function (_Component) {
  _inherits(IosReturnRight, _Component);

  function IosReturnRight(props) {
    _classCallCheck(this, IosReturnRight);

    var _this = _possibleConstructorReturn(this, (IosReturnRight.__proto__ || Object.getPrototypeOf(IosReturnRight)).call(this, props));
