...
var MdBeaker = function (_Component) {
  _inherits(MdBeaker, _Component);

  function MdBeaker(props) {
    _classCallCheck(this, MdBeaker);

    var _this = _possibleConstructorReturn(this, (MdBeaker.__proto__ || Object.getPrototypeOf(MdBeaker)).call(this, props));
