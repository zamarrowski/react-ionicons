...
var MdHappy = function (_Component) {
  _inherits(MdHappy, _Component);

  function MdHappy(props) {
    _classCallCheck(this, MdHappy);

    var _this = _possibleConstructorReturn(this, (MdHappy.__proto__ || Object.getPrototypeOf(MdHappy)).call(this, props));
