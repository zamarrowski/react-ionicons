...
var IosKeypad = function (_Component) {
  _inherits(IosKeypad, _Component);

  function IosKeypad(props) {
    _classCallCheck(this, IosKeypad);

    var _this = _possibleConstructorReturn(this, (IosKeypad.__proto__ || Object.getPrototypeOf(IosKeypad)).call(this, props));
