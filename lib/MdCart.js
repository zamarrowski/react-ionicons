...
var MdCart = function (_Component) {
  _inherits(MdCart, _Component);

  function MdCart(props) {
    _classCallCheck(this, MdCart);

    var _this = _possibleConstructorReturn(this, (MdCart.__proto__ || Object.getPrototypeOf(MdCart)).call(this, props));
