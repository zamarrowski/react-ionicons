...
var MdMusicalNotes = function (_Component) {
  _inherits(MdMusicalNotes, _Component);

  function MdMusicalNotes(props) {
    _classCallCheck(this, MdMusicalNotes);

    var _this = _possibleConstructorReturn(this, (MdMusicalNotes.__proto__ || Object.getPrototypeOf(MdMusicalNotes)).call(this, props));
