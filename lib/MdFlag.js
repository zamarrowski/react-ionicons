...
var MdFlag = function (_Component) {
  _inherits(MdFlag, _Component);

  function MdFlag(props) {
    _classCallCheck(this, MdFlag);

    var _this = _possibleConstructorReturn(this, (MdFlag.__proto__ || Object.getPrototypeOf(MdFlag)).call(this, props));
