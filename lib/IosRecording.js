...
var IosRecording = function (_Component) {
  _inherits(IosRecording, _Component);

  function IosRecording(props) {
    _classCallCheck(this, IosRecording);

    var _this = _possibleConstructorReturn(this, (IosRecording.__proto__ || Object.getPrototypeOf(IosRecording)).call(this, props));
