...
var IosAperture = function (_Component) {
  _inherits(IosAperture, _Component);

  function IosAperture(props) {
    _classCallCheck(this, IosAperture);

    var _this = _possibleConstructorReturn(this, (IosAperture.__proto__ || Object.getPrototypeOf(IosAperture)).call(this, props));
