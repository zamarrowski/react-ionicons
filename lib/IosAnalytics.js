...
var IosAnalytics = function (_Component) {
  _inherits(IosAnalytics, _Component);

  function IosAnalytics(props) {
    _classCallCheck(this, IosAnalytics);

    var _this = _possibleConstructorReturn(this, (IosAnalytics.__proto__ || Object.getPrototypeOf(IosAnalytics)).call(this, props));
