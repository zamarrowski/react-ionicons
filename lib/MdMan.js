...
var MdMan = function (_Component) {
  _inherits(MdMan, _Component);

  function MdMan(props) {
    _classCallCheck(this, MdMan);

    var _this = _possibleConstructorReturn(this, (MdMan.__proto__ || Object.getPrototypeOf(MdMan)).call(this, props));
