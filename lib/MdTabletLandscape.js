...
var MdTabletLandscape = function (_Component) {
  _inherits(MdTabletLandscape, _Component);

  function MdTabletLandscape(props) {
    _classCallCheck(this, MdTabletLandscape);

    var _this = _possibleConstructorReturn(this, (MdTabletLandscape.__proto__ || Object.getPrototypeOf(MdTabletLandscape)).call(this, props));
  ...
  _createClass(MdTabletLandscape, [{
    key: 'render',
