...
var MdCloseCircle = function (_Component) {
  _inherits(MdCloseCircle, _Component);

  function MdCloseCircle(props) {
    _classCallCheck(this, MdCloseCircle);

    var _this = _possibleConstructorReturn(this, (MdCloseCircle.__proto__ || Object.getPrototypeOf(MdCloseCircle)).call(this, props));
