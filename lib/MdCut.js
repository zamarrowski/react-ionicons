...
var MdCut = function (_Component) {
  _inherits(MdCut, _Component);

  function MdCut(props) {
    _classCallCheck(this, MdCut);

    var _this = _possibleConstructorReturn(this, (MdCut.__proto__ || Object.getPrototypeOf(MdCut)).call(this, props));
