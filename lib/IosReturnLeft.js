...
var IosReturnLeft = function (_Component) {
  _inherits(IosReturnLeft, _Component);

  function IosReturnLeft(props) {
    _classCallCheck(this, IosReturnLeft);

    var _this = _possibleConstructorReturn(this, (IosReturnLeft.__proto__ || Object.getPrototypeOf(IosReturnLeft)).call(this, props));
