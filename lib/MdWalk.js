...
var MdWalk = function (_Component) {
  _inherits(MdWalk, _Component);

  function MdWalk(props) {
    _classCallCheck(this, MdWalk);

    var _this = _possibleConstructorReturn(this, (MdWalk.__proto__ || Object.getPrototypeOf(MdWalk)).call(this, props));
