...
var IosTimer = function (_Component) {
  _inherits(IosTimer, _Component);

  function IosTimer(props) {
    _classCallCheck(this, IosTimer);

    var _this = _possibleConstructorReturn(this, (IosTimer.__proto__ || Object.getPrototypeOf(IosTimer)).call(this, props));
