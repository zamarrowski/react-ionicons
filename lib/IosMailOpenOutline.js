...
var IosMailOpenOutline = function (_Component) {
  _inherits(IosMailOpenOutline, _Component);

  function IosMailOpenOutline(props) {
    _classCallCheck(this, IosMailOpenOutline);

    var _this = _possibleConstructorReturn(this, (IosMailOpenOutline.__proto__ || Object.getPrototypeOf(IosMailOpenOutline)).call(this, props));
  ...
  _createClass(IosMailOpenOutline, [{
    key: 'render',
