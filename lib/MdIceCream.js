...
var MdIceCream = function (_Component) {
  _inherits(MdIceCream, _Component);

  function MdIceCream(props) {
    _classCallCheck(this, MdIceCream);

    var _this = _possibleConstructorReturn(this, (MdIceCream.__proto__ || Object.getPrototypeOf(MdIceCream)).call(this, props));
