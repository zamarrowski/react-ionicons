...
var IosEggOutline = function (_Component) {
  _inherits(IosEggOutline, _Component);

  function IosEggOutline(props) {
    _classCallCheck(this, IosEggOutline);

    var _this = _possibleConstructorReturn(this, (IosEggOutline.__proto__ || Object.getPrototypeOf(IosEggOutline)).call(this, props));
