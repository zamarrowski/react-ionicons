...
var IosBriefcase = function (_Component) {
  _inherits(IosBriefcase, _Component);

  function IosBriefcase(props) {
    _classCallCheck(this, IosBriefcase);

    var _this = _possibleConstructorReturn(this, (IosBriefcase.__proto__ || Object.getPrototypeOf(IosBriefcase)).call(this, props));
