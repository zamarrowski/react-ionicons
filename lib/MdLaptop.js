...
var MdLaptop = function (_Component) {
  _inherits(MdLaptop, _Component);

  function MdLaptop(props) {
    _classCallCheck(this, MdLaptop);

    var _this = _possibleConstructorReturn(this, (MdLaptop.__proto__ || Object.getPrototypeOf(MdLaptop)).call(this, props));
