...
var IosTrashOutline = function (_Component) {
  _inherits(IosTrashOutline, _Component);

  function IosTrashOutline(props) {
    _classCallCheck(this, IosTrashOutline);

    var _this = _possibleConstructorReturn(this, (IosTrashOutline.__proto__ || Object.getPrototypeOf(IosTrashOutline)).call(this, props));
