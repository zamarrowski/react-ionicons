...
var MdClock = function (_Component) {
  _inherits(MdClock, _Component);

  function MdClock(props) {
    _classCallCheck(this, MdClock);

    var _this = _possibleConstructorReturn(this, (MdClock.__proto__ || Object.getPrototypeOf(MdClock)).call(this, props));
