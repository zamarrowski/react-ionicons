...
var IosCog = function (_Component) {
  _inherits(IosCog, _Component);

  function IosCog(props) {
    _classCallCheck(this, IosCog);

    var _this = _possibleConstructorReturn(this, (IosCog.__proto__ || Object.getPrototypeOf(IosCog)).call(this, props));
