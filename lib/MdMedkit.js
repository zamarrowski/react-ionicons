...
var MdMedkit = function (_Component) {
  _inherits(MdMedkit, _Component);

  function MdMedkit(props) {
    _classCallCheck(this, MdMedkit);

    var _this = _possibleConstructorReturn(this, (MdMedkit.__proto__ || Object.getPrototypeOf(MdMedkit)).call(this, props));
