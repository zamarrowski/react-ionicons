...
var IosCloudUploadOutline = function (_Component) {
  _inherits(IosCloudUploadOutline, _Component);

  function IosCloudUploadOutline(props) {
    _classCallCheck(this, IosCloudUploadOutline);

    var _this = _possibleConstructorReturn(this, (IosCloudUploadOutline.__proto__ || Object.getPrototypeOf(IosCloudUploadOutline)).call(this, props));
