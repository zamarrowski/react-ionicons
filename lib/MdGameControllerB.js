...
var MdGameControllerB = function (_Component) {
  _inherits(MdGameControllerB, _Component);

  function MdGameControllerB(props) {
    _classCallCheck(this, MdGameControllerB);

    var _this = _possibleConstructorReturn(this, (MdGameControllerB.__proto__ || Object.getPrototypeOf(MdGameControllerB)).call(this, props));
  ...
  _createClass(MdGameControllerB, [{
    key: 'render',
