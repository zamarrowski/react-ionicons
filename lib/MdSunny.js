...
var MdSunny = function (_Component) {
  _inherits(MdSunny, _Component);

  function MdSunny(props) {
    _classCallCheck(this, MdSunny);

    var _this = _possibleConstructorReturn(this, (MdSunny.__proto__ || Object.getPrototypeOf(MdSunny)).call(this, props));
