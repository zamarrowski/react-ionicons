...
var IosThermometer = function (_Component) {
  _inherits(IosThermometer, _Component);

  function IosThermometer(props) {
    _classCallCheck(this, IosThermometer);

    var _this = _possibleConstructorReturn(this, (IosThermometer.__proto__ || Object.getPrototypeOf(IosThermometer)).call(this, props));
