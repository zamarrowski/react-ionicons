...
var IosCamera = function (_Component) {
  _inherits(IosCamera, _Component);

  function IosCamera(props) {
    _classCallCheck(this, IosCamera);

    var _this = _possibleConstructorReturn(this, (IosCamera.__proto__ || Object.getPrototypeOf(IosCamera)).call(this, props));
