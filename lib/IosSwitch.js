...
var IosSwitch = function (_Component) {
  _inherits(IosSwitch, _Component);

  function IosSwitch(props) {
    _classCallCheck(this, IosSwitch);

    var _this = _possibleConstructorReturn(this, (IosSwitch.__proto__ || Object.getPrototypeOf(IosSwitch)).call(this, props));
