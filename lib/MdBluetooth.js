...
var MdBluetooth = function (_Component) {
  _inherits(MdBluetooth, _Component);

  function MdBluetooth(props) {
    _classCallCheck(this, MdBluetooth);

    var _this = _possibleConstructorReturn(this, (MdBluetooth.__proto__ || Object.getPrototypeOf(MdBluetooth)).call(this, props));
