...
var IosCloudy = function (_Component) {
  _inherits(IosCloudy, _Component);

  function IosCloudy(props) {
    _classCallCheck(this, IosCloudy);

    var _this = _possibleConstructorReturn(this, (IosCloudy.__proto__ || Object.getPrototypeOf(IosCloudy)).call(this, props));
