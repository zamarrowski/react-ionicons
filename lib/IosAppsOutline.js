...
var IosAppsOutline = function (_Component) {
  _inherits(IosAppsOutline, _Component);

  function IosAppsOutline(props) {
    _classCallCheck(this, IosAppsOutline);

    var _this = _possibleConstructorReturn(this, (IosAppsOutline.__proto__ || Object.getPrototypeOf(IosAppsOutline)).call(this, props));
