...
var MdMailOpen = function (_Component) {
  _inherits(MdMailOpen, _Component);

  function MdMailOpen(props) {
    _classCallCheck(this, MdMailOpen);

    var _this = _possibleConstructorReturn(this, (MdMailOpen.__proto__ || Object.getPrototypeOf(MdMailOpen)).call(this, props));
