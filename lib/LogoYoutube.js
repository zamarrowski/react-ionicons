...
var LogoYoutube = function (_Component) {
  _inherits(LogoYoutube, _Component);

  function LogoYoutube(props) {
    _classCallCheck(this, LogoYoutube);

    var _this = _possibleConstructorReturn(this, (LogoYoutube.__proto__ || Object.getPrototypeOf(LogoYoutube)).call(this, props));
