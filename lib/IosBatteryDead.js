...
var IosBatteryDead = function (_Component) {
  _inherits(IosBatteryDead, _Component);

  function IosBatteryDead(props) {
    _classCallCheck(this, IosBatteryDead);

    var _this = _possibleConstructorReturn(this, (IosBatteryDead.__proto__ || Object.getPrototypeOf(IosBatteryDead)).call(this, props));
