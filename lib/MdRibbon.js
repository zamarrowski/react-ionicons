...
var MdRibbon = function (_Component) {
  _inherits(MdRibbon, _Component);

  function MdRibbon(props) {
    _classCallCheck(this, MdRibbon);

    var _this = _possibleConstructorReturn(this, (MdRibbon.__proto__ || Object.getPrototypeOf(MdRibbon)).call(this, props));
