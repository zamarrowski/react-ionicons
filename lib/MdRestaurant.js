...
var MdRestaurant = function (_Component) {
  _inherits(MdRestaurant, _Component);

  function MdRestaurant(props) {
    _classCallCheck(this, MdRestaurant);

    var _this = _possibleConstructorReturn(this, (MdRestaurant.__proto__ || Object.getPrototypeOf(MdRestaurant)).call(this, props));
