...
var MdColorFilter = function (_Component) {
  _inherits(MdColorFilter, _Component);

  function MdColorFilter(props) {
    _classCallCheck(this, MdColorFilter);

    var _this = _possibleConstructorReturn(this, (MdColorFilter.__proto__ || Object.getPrototypeOf(MdColorFilter)).call(this, props));
