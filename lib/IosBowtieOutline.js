...
var IosBowtieOutline = function (_Component) {
  _inherits(IosBowtieOutline, _Component);

  function IosBowtieOutline(props) {
    _classCallCheck(this, IosBowtieOutline);

    var _this = _possibleConstructorReturn(this, (IosBowtieOutline.__proto__ || Object.getPrototypeOf(IosBowtieOutline)).call(this, props));
