...
var MdBasket = function (_Component) {
  _inherits(MdBasket, _Component);

  function MdBasket(props) {
    _classCallCheck(this, MdBasket);

    var _this = _possibleConstructorReturn(this, (MdBasket.__proto__ || Object.getPrototypeOf(MdBasket)).call(this, props));
