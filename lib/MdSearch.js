...
var MdSearch = function (_Component) {
  _inherits(MdSearch, _Component);

  function MdSearch(props) {
    _classCallCheck(this, MdSearch);

    var _this = _possibleConstructorReturn(this, (MdSearch.__proto__ || Object.getPrototypeOf(MdSearch)).call(this, props));
