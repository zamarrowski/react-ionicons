...
var IosStopwatch = function (_Component) {
  _inherits(IosStopwatch, _Component);

  function IosStopwatch(props) {
    _classCallCheck(this, IosStopwatch);

    var _this = _possibleConstructorReturn(this, (IosStopwatch.__proto__ || Object.getPrototypeOf(IosStopwatch)).call(this, props));
