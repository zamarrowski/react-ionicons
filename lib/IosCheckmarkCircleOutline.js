...
var IosCheckmarkCircleOutline = function (_Component) {
  _inherits(IosCheckmarkCircleOutline, _Component);

  function IosCheckmarkCircleOutline(props) {
    _classCallCheck(this, IosCheckmarkCircleOutline);

    var _this = _possibleConstructorReturn(this, (IosCheckmarkCircleOutline.__proto__ || Object.getPrototypeOf(IosCheckmarkCircleOutline)).call(this, props));
  ...
  _createClass(IosCheckmarkCircleOutline, [{
    key: 'render',
