...
var IosAttach = function (_Component) {
  _inherits(IosAttach, _Component);

  function IosAttach(props) {
    _classCallCheck(this, IosAttach);

    var _this = _possibleConstructorReturn(this, (IosAttach.__proto__ || Object.getPrototypeOf(IosAttach)).call(this, props));
