...
var MdTransgender = function (_Component) {
  _inherits(MdTransgender, _Component);

  function MdTransgender(props) {
    _classCallCheck(this, MdTransgender);

    var _this = _possibleConstructorReturn(this, (MdTransgender.__proto__ || Object.getPrototypeOf(MdTransgender)).call(this, props));
