...
var IosHand = function (_Component) {
  _inherits(IosHand, _Component);

  function IosHand(props) {
    _classCallCheck(this, IosHand);

    var _this = _possibleConstructorReturn(this, (IosHand.__proto__ || Object.getPrototypeOf(IosHand)).call(this, props));
