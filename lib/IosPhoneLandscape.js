...
var IosPhoneLandscape = function (_Component) {
  _inherits(IosPhoneLandscape, _Component);

  function IosPhoneLandscape(props) {
    _classCallCheck(this, IosPhoneLandscape);

    var _this = _possibleConstructorReturn(this, (IosPhoneLandscape.__proto__ || Object.getPrototypeOf(IosPhoneLandscape)).call(this, props));
  ...
  _createClass(IosPhoneLandscape, [{
    key: 'render',
