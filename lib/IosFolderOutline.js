...
var IosFolderOutline = function (_Component) {
  _inherits(IosFolderOutline, _Component);

  function IosFolderOutline(props) {
    _classCallCheck(this, IosFolderOutline);

    var _this = _possibleConstructorReturn(this, (IosFolderOutline.__proto__ || Object.getPrototypeOf(IosFolderOutline)).call(this, props));
