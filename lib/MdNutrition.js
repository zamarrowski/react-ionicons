...
var MdNutrition = function (_Component) {
  _inherits(MdNutrition, _Component);

  function MdNutrition(props) {
    _classCallCheck(this, MdNutrition);

    var _this = _possibleConstructorReturn(this, (MdNutrition.__proto__ || Object.getPrototypeOf(MdNutrition)).call(this, props));
