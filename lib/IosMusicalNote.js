...
var IosMusicalNote = function (_Component) {
  _inherits(IosMusicalNote, _Component);

  function IosMusicalNote(props) {
    _classCallCheck(this, IosMusicalNote);

    var _this = _possibleConstructorReturn(this, (IosMusicalNote.__proto__ || Object.getPrototypeOf(IosMusicalNote)).call(this, props));
