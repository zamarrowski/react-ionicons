...
var MdGitCommit = function (_Component) {
  _inherits(MdGitCommit, _Component);

  function MdGitCommit(props) {
    _classCallCheck(this, MdGitCommit);

    var _this = _possibleConstructorReturn(this, (MdGitCommit.__proto__ || Object.getPrototypeOf(MdGitCommit)).call(this, props));
