...
var MdMale = function (_Component) {
  _inherits(MdMale, _Component);

  function MdMale(props) {
    _classCallCheck(this, MdMale);

    var _this = _possibleConstructorReturn(this, (MdMale.__proto__ || Object.getPrototypeOf(MdMale)).call(this, props));
