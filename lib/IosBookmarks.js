...
var IosBookmarks = function (_Component) {
  _inherits(IosBookmarks, _Component);

  function IosBookmarks(props) {
    _classCallCheck(this, IosBookmarks);

    var _this = _possibleConstructorReturn(this, (IosBookmarks.__proto__ || Object.getPrototypeOf(IosBookmarks)).call(this, props));
