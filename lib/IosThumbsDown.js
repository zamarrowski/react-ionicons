...
var IosThumbsDown = function (_Component) {
  _inherits(IosThumbsDown, _Component);

  function IosThumbsDown(props) {
    _classCallCheck(this, IosThumbsDown);

    var _this = _possibleConstructorReturn(this, (IosThumbsDown.__proto__ || Object.getPrototypeOf(IosThumbsDown)).call(this, props));
