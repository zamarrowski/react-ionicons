...
var MdBug = function (_Component) {
  _inherits(MdBug, _Component);

  function MdBug(props) {
    _classCallCheck(this, MdBug);

    var _this = _possibleConstructorReturn(this, (MdBug.__proto__ || Object.getPrototypeOf(MdBug)).call(this, props));
