...
var IosPulseOutline = function (_Component) {
  _inherits(IosPulseOutline, _Component);

  function IosPulseOutline(props) {
    _classCallCheck(this, IosPulseOutline);

    var _this = _possibleConstructorReturn(this, (IosPulseOutline.__proto__ || Object.getPrototypeOf(IosPulseOutline)).call(this, props));
