...
var IosTabletPortrait = function (_Component) {
  _inherits(IosTabletPortrait, _Component);

  function IosTabletPortrait(props) {
    _classCallCheck(this, IosTabletPortrait);

    var _this = _possibleConstructorReturn(this, (IosTabletPortrait.__proto__ || Object.getPrototypeOf(IosTabletPortrait)).call(this, props));
  ...
  _createClass(IosTabletPortrait, [{
    key: 'render',
