...
var LogoMarkdown = function (_Component) {
  _inherits(LogoMarkdown, _Component);

  function LogoMarkdown(props) {
    _classCallCheck(this, LogoMarkdown);

    var _this = _possibleConstructorReturn(this, (LogoMarkdown.__proto__ || Object.getPrototypeOf(LogoMarkdown)).call(this, props));
