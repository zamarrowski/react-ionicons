...
var IosPersonAddOutline = function (_Component) {
  _inherits(IosPersonAddOutline, _Component);

  function IosPersonAddOutline(props) {
    _classCallCheck(this, IosPersonAddOutline);

    var _this = _possibleConstructorReturn(this, (IosPersonAddOutline.__proto__ || Object.getPrototypeOf(IosPersonAddOutline)).call(this, props));
  ...
  _createClass(IosPersonAddOutline, [{
    key: 'render',
  ...
  return IosPersonAddOutline;
}(_react.Component);

IosPersonAddOutline.defaultProps = {
  // style
  style: {},
  color: '#000000',
  fontSize: '22px',
...
exports.default = IosPersonAddOutline;
module.exports = exports['default'];
//# sourceMappingURL=IosPersonAddOutline.js.map