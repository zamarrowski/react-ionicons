...
var IosBrush = function (_Component) {
  _inherits(IosBrush, _Component);

  function IosBrush(props) {
    _classCallCheck(this, IosBrush);

    var _this = _possibleConstructorReturn(this, (IosBrush.__proto__ || Object.getPrototypeOf(IosBrush)).call(this, props));
