...
var IosCalculator = function (_Component) {
  _inherits(IosCalculator, _Component);

  function IosCalculator(props) {
    _classCallCheck(this, IosCalculator);

    var _this = _possibleConstructorReturn(this, (IosCalculator.__proto__ || Object.getPrototypeOf(IosCalculator)).call(this, props));
