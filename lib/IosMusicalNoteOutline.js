...
var IosMusicalNoteOutline = function (_Component) {
  _inherits(IosMusicalNoteOutline, _Component);

  function IosMusicalNoteOutline(props) {
    _classCallCheck(this, IosMusicalNoteOutline);

    var _this = _possibleConstructorReturn(this, (IosMusicalNoteOutline.__proto__ || Object.getPrototypeOf(IosMusicalNoteOutline)).call(this, props));
  ...
  _createClass(IosMusicalNoteOutline, [{
    key: 'render',
