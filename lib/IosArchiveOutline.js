...
var IosArchiveOutline = function (_Component) {
  _inherits(IosArchiveOutline, _Component);

  function IosArchiveOutline(props) {
    _classCallCheck(this, IosArchiveOutline);

    var _this = _possibleConstructorReturn(this, (IosArchiveOutline.__proto__ || Object.getPrototypeOf(IosArchiveOutline)).call(this, props));
  ...
  _createClass(IosArchiveOutline, [{
    key: 'render',
