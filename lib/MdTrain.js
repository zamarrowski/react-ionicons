...
var MdTrain = function (_Component) {
  _inherits(MdTrain, _Component);

  function MdTrain(props) {
    _classCallCheck(this, MdTrain);

    var _this = _possibleConstructorReturn(this, (MdTrain.__proto__ || Object.getPrototypeOf(MdTrain)).call(this, props));
