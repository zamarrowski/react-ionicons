...
var MdFilm = function (_Component) {
  _inherits(MdFilm, _Component);

  function MdFilm(props) {
    _classCallCheck(this, MdFilm);

    var _this = _possibleConstructorReturn(this, (MdFilm.__proto__ || Object.getPrototypeOf(MdFilm)).call(this, props));
