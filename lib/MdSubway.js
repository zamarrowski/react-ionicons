...
var MdSubway = function (_Component) {
  _inherits(MdSubway, _Component);

  function MdSubway(props) {
    _classCallCheck(this, MdSubway);

    var _this = _possibleConstructorReturn(this, (MdSubway.__proto__ || Object.getPrototypeOf(MdSubway)).call(this, props));
