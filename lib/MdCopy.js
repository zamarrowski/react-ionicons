...
var MdCopy = function (_Component) {
  _inherits(MdCopy, _Component);

  function MdCopy(props) {
    _classCallCheck(this, MdCopy);

    var _this = _possibleConstructorReturn(this, (MdCopy.__proto__ || Object.getPrototypeOf(MdCopy)).call(this, props));
