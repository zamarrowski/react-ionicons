...
var IosThumbsUpOutline = function (_Component) {
  _inherits(IosThumbsUpOutline, _Component);

  function IosThumbsUpOutline(props) {
    _classCallCheck(this, IosThumbsUpOutline);

    var _this = _possibleConstructorReturn(this, (IosThumbsUpOutline.__proto__ || Object.getPrototypeOf(IosThumbsUpOutline)).call(this, props));
  ...
  _createClass(IosThumbsUpOutline, [{
    key: 'render',
