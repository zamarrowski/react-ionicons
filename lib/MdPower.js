...
var MdPower = function (_Component) {
  _inherits(MdPower, _Component);

  function MdPower(props) {
    _classCallCheck(this, MdPower);

    var _this = _possibleConstructorReturn(this, (MdPower.__proto__ || Object.getPrototypeOf(MdPower)).call(this, props));
