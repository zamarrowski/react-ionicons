...
var IosVolumeUp = function (_Component) {
  _inherits(IosVolumeUp, _Component);

  function IosVolumeUp(props) {
    _classCallCheck(this, IosVolumeUp);

    var _this = _possibleConstructorReturn(this, (IosVolumeUp.__proto__ || Object.getPrototypeOf(IosVolumeUp)).call(this, props));
