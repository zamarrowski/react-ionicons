...
var MdCodeDownload = function (_Component) {
  _inherits(MdCodeDownload, _Component);

  function MdCodeDownload(props) {
    _classCallCheck(this, MdCodeDownload);

    var _this = _possibleConstructorReturn(this, (MdCodeDownload.__proto__ || Object.getPrototypeOf(MdCodeDownload)).call(this, props));
