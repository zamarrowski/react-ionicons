...
var MdBuild = function (_Component) {
  _inherits(MdBuild, _Component);

  function MdBuild(props) {
    _classCallCheck(this, MdBuild);

    var _this = _possibleConstructorReturn(this, (MdBuild.__proto__ || Object.getPrototypeOf(MdBuild)).call(this, props));
