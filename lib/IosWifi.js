...
var IosWifi = function (_Component) {
  _inherits(IosWifi, _Component);

  function IosWifi(props) {
    _classCallCheck(this, IosWifi);

    var _this = _possibleConstructorReturn(this, (IosWifi.__proto__ || Object.getPrototypeOf(IosWifi)).call(this, props));
