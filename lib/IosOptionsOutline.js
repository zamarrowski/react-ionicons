...
var IosOptionsOutline = function (_Component) {
  _inherits(IosOptionsOutline, _Component);

  function IosOptionsOutline(props) {
    _classCallCheck(this, IosOptionsOutline);

    var _this = _possibleConstructorReturn(this, (IosOptionsOutline.__proto__ || Object.getPrototypeOf(IosOptionsOutline)).call(this, props));
  ...
  _createClass(IosOptionsOutline, [{
    key: 'render',
