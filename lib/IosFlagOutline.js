...
var IosFlagOutline = function (_Component) {
  _inherits(IosFlagOutline, _Component);

  function IosFlagOutline(props) {
    _classCallCheck(this, IosFlagOutline);

    var _this = _possibleConstructorReturn(this, (IosFlagOutline.__proto__ || Object.getPrototypeOf(IosFlagOutline)).call(this, props));
