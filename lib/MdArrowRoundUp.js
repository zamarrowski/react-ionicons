...
var MdArrowRoundUp = function (_Component) {
  _inherits(MdArrowRoundUp, _Component);

  function MdArrowRoundUp(props) {
    _classCallCheck(this, MdArrowRoundUp);

    var _this = _possibleConstructorReturn(this, (MdArrowRoundUp.__proto__ || Object.getPrototypeOf(MdArrowRoundUp)).call(this, props));
