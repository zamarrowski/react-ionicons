...
var IosLogIn = function (_Component) {
  _inherits(IosLogIn, _Component);

  function IosLogIn(props) {
    _classCallCheck(this, IosLogIn);

    var _this = _possibleConstructorReturn(this, (IosLogIn.__proto__ || Object.getPrototypeOf(IosLogIn)).call(this, props));
