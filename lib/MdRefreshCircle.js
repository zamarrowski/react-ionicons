...
var MdRefreshCircle = function (_Component) {
  _inherits(MdRefreshCircle, _Component);

  function MdRefreshCircle(props) {
    _classCallCheck(this, MdRefreshCircle);

    var _this = _possibleConstructorReturn(this, (MdRefreshCircle.__proto__ || Object.getPrototypeOf(MdRefreshCircle)).call(this, props));
