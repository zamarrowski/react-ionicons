...
var LogoEuro = function (_Component) {
  _inherits(LogoEuro, _Component);

  function LogoEuro(props) {
    _classCallCheck(this, LogoEuro);

    var _this = _possibleConstructorReturn(this, (LogoEuro.__proto__ || Object.getPrototypeOf(LogoEuro)).call(this, props));
