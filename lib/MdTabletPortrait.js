...
var MdTabletPortrait = function (_Component) {
  _inherits(MdTabletPortrait, _Component);

  function MdTabletPortrait(props) {
    _classCallCheck(this, MdTabletPortrait);

    var _this = _possibleConstructorReturn(this, (MdTabletPortrait.__proto__ || Object.getPrototypeOf(MdTabletPortrait)).call(this, props));
