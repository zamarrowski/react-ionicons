...
var IosVideocamOutline = function (_Component) {
  _inherits(IosVideocamOutline, _Component);

  function IosVideocamOutline(props) {
    _classCallCheck(this, IosVideocamOutline);

    var _this = _possibleConstructorReturn(this, (IosVideocamOutline.__proto__ || Object.getPrototypeOf(IosVideocamOutline)).call(this, props));
