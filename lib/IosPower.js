...
var IosPower = function (_Component) {
  _inherits(IosPower, _Component);

  function IosPower(props) {
    _classCallCheck(this, IosPower);

    var _this = _possibleConstructorReturn(this, (IosPower.__proto__ || Object.getPrototypeOf(IosPower)).call(this, props));
