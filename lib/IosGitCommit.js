...
var IosGitCommit = function (_Component) {
  _inherits(IosGitCommit, _Component);

  function IosGitCommit(props) {
    _classCallCheck(this, IosGitCommit);

    var _this = _possibleConstructorReturn(this, (IosGitCommit.__proto__ || Object.getPrototypeOf(IosGitCommit)).call(this, props));
