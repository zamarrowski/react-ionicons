...
var MdGlobe = function (_Component) {
  _inherits(MdGlobe, _Component);

  function MdGlobe(props) {
    _classCallCheck(this, MdGlobe);

    var _this = _possibleConstructorReturn(this, (MdGlobe.__proto__ || Object.getPrototypeOf(MdGlobe)).call(this, props));
