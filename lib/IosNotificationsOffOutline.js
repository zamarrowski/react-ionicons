...
var IosNotificationsOffOutline = function (_Component) {
  _inherits(IosNotificationsOffOutline, _Component);

  function IosNotificationsOffOutline(props) {
    _classCallCheck(this, IosNotificationsOffOutline);

    var _this = _possibleConstructorReturn(this, (IosNotificationsOffOutline.__proto__ || Object.getPrototypeOf(IosNotificationsOffOutline)).call(this, props));
  ...
  _createClass(IosNotificationsOffOutline, [{
    key: 'render',
  ...
  return IosNotificationsOffOutline;
}(_react.Component);
