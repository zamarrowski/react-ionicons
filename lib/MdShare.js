...
var MdShare = function (_Component) {
  _inherits(MdShare, _Component);

  function MdShare(props) {
    _classCallCheck(this, MdShare);

    var _this = _possibleConstructorReturn(this, (MdShare.__proto__ || Object.getPrototypeOf(MdShare)).call(this, props));
