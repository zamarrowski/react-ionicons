...
var IosGitNetwork = function (_Component) {
  _inherits(IosGitNetwork, _Component);

  function IosGitNetwork(props) {
    _classCallCheck(this, IosGitNetwork);

    var _this = _possibleConstructorReturn(this, (IosGitNetwork.__proto__ || Object.getPrototypeOf(IosGitNetwork)).call(this, props));
