...
var IosThermometerOutline = function (_Component) {
  _inherits(IosThermometerOutline, _Component);

  function IosThermometerOutline(props) {
    _classCallCheck(this, IosThermometerOutline);

    var _this = _possibleConstructorReturn(this, (IosThermometerOutline.__proto__ || Object.getPrototypeOf(IosThermometerOutline)).call(this, props));
  ...
  _createClass(IosThermometerOutline, [{
    key: 'render',
