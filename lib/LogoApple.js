...
var LogoApple = function (_Component) {
  _inherits(LogoApple, _Component);

  function LogoApple(props) {
    _classCallCheck(this, LogoApple);

    var _this = _possibleConstructorReturn(this, (LogoApple.__proto__ || Object.getPrototypeOf(LogoApple)).call(this, props));
