...
var MdStopwatch = function (_Component) {
  _inherits(MdStopwatch, _Component);

  function MdStopwatch(props) {
    _classCallCheck(this, MdStopwatch);

    var _this = _possibleConstructorReturn(this, (MdStopwatch.__proto__ || Object.getPrototypeOf(MdStopwatch)).call(this, props));
