...
var IosBulb = function (_Component) {
  _inherits(IosBulb, _Component);

  function IosBulb(props) {
    _classCallCheck(this, IosBulb);

    var _this = _possibleConstructorReturn(this, (IosBulb.__proto__ || Object.getPrototypeOf(IosBulb)).call(this, props));
