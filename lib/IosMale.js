...
var IosMale = function (_Component) {
  _inherits(IosMale, _Component);

  function IosMale(props) {
    _classCallCheck(this, IosMale);

    var _this = _possibleConstructorReturn(this, (IosMale.__proto__ || Object.getPrototypeOf(IosMale)).call(this, props));
