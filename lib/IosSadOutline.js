...
var IosSadOutline = function (_Component) {
  _inherits(IosSadOutline, _Component);

  function IosSadOutline(props) {
    _classCallCheck(this, IosSadOutline);

    var _this = _possibleConstructorReturn(this, (IosSadOutline.__proto__ || Object.getPrototypeOf(IosSadOutline)).call(this, props));
