...
var MdFlower = function (_Component) {
  _inherits(MdFlower, _Component);

  function MdFlower(props) {
    _classCallCheck(this, MdFlower);

    var _this = _possibleConstructorReturn(this, (MdFlower.__proto__ || Object.getPrototypeOf(MdFlower)).call(this, props));
