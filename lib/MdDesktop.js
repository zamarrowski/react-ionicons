...
var MdDesktop = function (_Component) {
  _inherits(MdDesktop, _Component);

  function MdDesktop(props) {
    _classCallCheck(this, MdDesktop);

    var _this = _possibleConstructorReturn(this, (MdDesktop.__proto__ || Object.getPrototypeOf(MdDesktop)).call(this, props));
