...
var IosHappy = function (_Component) {
  _inherits(IosHappy, _Component);

  function IosHappy(props) {
    _classCallCheck(this, IosHappy);

    var _this = _possibleConstructorReturn(this, (IosHappy.__proto__ || Object.getPrototypeOf(IosHappy)).call(this, props));
