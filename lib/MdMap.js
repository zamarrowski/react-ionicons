...
var MdMap = function (_Component) {
  _inherits(MdMap, _Component);

  function MdMap(props) {
    _classCallCheck(this, MdMap);

    var _this = _possibleConstructorReturn(this, (MdMap.__proto__ || Object.getPrototypeOf(MdMap)).call(this, props));
