...
var IosSearch = function (_Component) {
  _inherits(IosSearch, _Component);

  function IosSearch(props) {
    _classCallCheck(this, IosSearch);

    var _this = _possibleConstructorReturn(this, (IosSearch.__proto__ || Object.getPrototypeOf(IosSearch)).call(this, props));
