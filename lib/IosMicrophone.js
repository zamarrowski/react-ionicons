...
var IosMicrophone = function (_Component) {
  _inherits(IosMicrophone, _Component);

  function IosMicrophone(props) {
    _classCallCheck(this, IosMicrophone);

    var _this = _possibleConstructorReturn(this, (IosMicrophone.__proto__ || Object.getPrototypeOf(IosMicrophone)).call(this, props));
