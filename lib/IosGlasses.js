...
var IosGlasses = function (_Component) {
  _inherits(IosGlasses, _Component);

  function IosGlasses(props) {
    _classCallCheck(this, IosGlasses);

    var _this = _possibleConstructorReturn(this, (IosGlasses.__proto__ || Object.getPrototypeOf(IosGlasses)).call(this, props));
