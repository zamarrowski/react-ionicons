...
var IosPeople = function (_Component) {
  _inherits(IosPeople, _Component);

  function IosPeople(props) {
    _classCallCheck(this, IosPeople);

    var _this = _possibleConstructorReturn(this, (IosPeople.__proto__ || Object.getPrototypeOf(IosPeople)).call(this, props));
