...
var MdTime = function (_Component) {
  _inherits(MdTime, _Component);

  function MdTime(props) {
    _classCallCheck(this, MdTime);

    var _this = _possibleConstructorReturn(this, (MdTime.__proto__ || Object.getPrototypeOf(MdTime)).call(this, props));
