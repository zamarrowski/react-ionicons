...
var MdThumbsUp = function (_Component) {
  _inherits(MdThumbsUp, _Component);

  function MdThumbsUp(props) {
    _classCallCheck(this, MdThumbsUp);

    var _this = _possibleConstructorReturn(this, (MdThumbsUp.__proto__ || Object.getPrototypeOf(MdThumbsUp)).call(this, props));
