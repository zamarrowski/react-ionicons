...
var MdCamera = function (_Component) {
  _inherits(MdCamera, _Component);

  function MdCamera(props) {
    _classCallCheck(this, MdCamera);

    var _this = _possibleConstructorReturn(this, (MdCamera.__proto__ || Object.getPrototypeOf(MdCamera)).call(this, props));
