...
var IosNotificationsOff = function (_Component) {
  _inherits(IosNotificationsOff, _Component);

  function IosNotificationsOff(props) {
    _classCallCheck(this, IosNotificationsOff);

    var _this = _possibleConstructorReturn(this, (IosNotificationsOff.__proto__ || Object.getPrototypeOf(IosNotificationsOff)).call(this, props));
  ...
  _createClass(IosNotificationsOff, [{
    key: 'render',
