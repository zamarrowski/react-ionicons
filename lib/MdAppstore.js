...
var MdAppstore = function (_Component) {
  _inherits(MdAppstore, _Component);

  function MdAppstore(props) {
    _classCallCheck(this, MdAppstore);

    var _this = _possibleConstructorReturn(this, (MdAppstore.__proto__ || Object.getPrototypeOf(MdAppstore)).call(this, props));
