...
var MdSync = function (_Component) {
  _inherits(MdSync, _Component);

  function MdSync(props) {
    _classCallCheck(this, MdSync);

    var _this = _possibleConstructorReturn(this, (MdSync.__proto__ || Object.getPrototypeOf(MdSync)).call(this, props));
