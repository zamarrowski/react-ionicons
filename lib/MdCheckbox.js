...
var MdCheckbox = function (_Component) {
  _inherits(MdCheckbox, _Component);

  function MdCheckbox(props) {
    _classCallCheck(this, MdCheckbox);

    var _this = _possibleConstructorReturn(this, (MdCheckbox.__proto__ || Object.getPrototypeOf(MdCheckbox)).call(this, props));
