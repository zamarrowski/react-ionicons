...
var IosText = function (_Component) {
  _inherits(IosText, _Component);

  function IosText(props) {
    _classCallCheck(this, IosText);

    var _this = _possibleConstructorReturn(this, (IosText.__proto__ || Object.getPrototypeOf(IosText)).call(this, props));
