...
var IosCreate = function (_Component) {
  _inherits(IosCreate, _Component);

  function IosCreate(props) {
    _classCallCheck(this, IosCreate);

    var _this = _possibleConstructorReturn(this, (IosCreate.__proto__ || Object.getPrototypeOf(IosCreate)).call(this, props));
