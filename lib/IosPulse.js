...
var IosPulse = function (_Component) {
  _inherits(IosPulse, _Component);

  function IosPulse(props) {
    _classCallCheck(this, IosPulse);

    var _this = _possibleConstructorReturn(this, (IosPulse.__proto__ || Object.getPrototypeOf(IosPulse)).call(this, props));
