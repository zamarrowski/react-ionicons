...
var IosFlower = function (_Component) {
  _inherits(IosFlower, _Component);

  function IosFlower(props) {
    _classCallCheck(this, IosFlower);

    var _this = _possibleConstructorReturn(this, (IosFlower.__proto__ || Object.getPrototypeOf(IosFlower)).call(this, props));
