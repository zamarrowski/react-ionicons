...
var MdBatteryDead = function (_Component) {
  _inherits(MdBatteryDead, _Component);

  function MdBatteryDead(props) {
    _classCallCheck(this, MdBatteryDead);

    var _this = _possibleConstructorReturn(this, (MdBatteryDead.__proto__ || Object.getPrototypeOf(MdBatteryDead)).call(this, props));
