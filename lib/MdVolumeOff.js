...
var MdVolumeOff = function (_Component) {
  _inherits(MdVolumeOff, _Component);

  function MdVolumeOff(props) {
    _classCallCheck(this, MdVolumeOff);

    var _this = _possibleConstructorReturn(this, (MdVolumeOff.__proto__ || Object.getPrototypeOf(MdVolumeOff)).call(this, props));
