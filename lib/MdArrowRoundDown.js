...
var MdArrowRoundDown = function (_Component) {
  _inherits(MdArrowRoundDown, _Component);

  function MdArrowRoundDown(props) {
    _classCallCheck(this, MdArrowRoundDown);

    var _this = _possibleConstructorReturn(this, (MdArrowRoundDown.__proto__ || Object.getPrototypeOf(MdArrowRoundDown)).call(this, props));
