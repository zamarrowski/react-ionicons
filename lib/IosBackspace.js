...
var IosBackspace = function (_Component) {
  _inherits(IosBackspace, _Component);

  function IosBackspace(props) {
    _classCallCheck(this, IosBackspace);

    var _this = _possibleConstructorReturn(this, (IosBackspace.__proto__ || Object.getPrototypeOf(IosBackspace)).call(this, props));
