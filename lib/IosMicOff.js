...
var IosMicOff = function (_Component) {
  _inherits(IosMicOff, _Component);

  function IosMicOff(props) {
    _classCallCheck(this, IosMicOff);

    var _this = _possibleConstructorReturn(this, (IosMicOff.__proto__ || Object.getPrototypeOf(IosMicOff)).call(this, props));
