...
var IosWoman = function (_Component) {
  _inherits(IosWoman, _Component);

  function IosWoman(props) {
    _classCallCheck(this, IosWoman);

    var _this = _possibleConstructorReturn(this, (IosWoman.__proto__ || Object.getPrototypeOf(IosWoman)).call(this, props));
