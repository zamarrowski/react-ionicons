...
var MdRadio = function (_Component) {
  _inherits(MdRadio, _Component);

  function MdRadio(props) {
    _classCallCheck(this, MdRadio);

    var _this = _possibleConstructorReturn(this, (MdRadio.__proto__ || Object.getPrototypeOf(MdRadio)).call(this, props));
