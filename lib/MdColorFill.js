...
var MdColorFill = function (_Component) {
  _inherits(MdColorFill, _Component);

  function MdColorFill(props) {
    _classCallCheck(this, MdColorFill);

    var _this = _possibleConstructorReturn(this, (MdColorFill.__proto__ || Object.getPrototypeOf(MdColorFill)).call(this, props));
