...
var MdNuclear = function (_Component) {
  _inherits(MdNuclear, _Component);

  function MdNuclear(props) {
    _classCallCheck(this, MdNuclear);

    var _this = _possibleConstructorReturn(this, (MdNuclear.__proto__ || Object.getPrototypeOf(MdNuclear)).call(this, props));
