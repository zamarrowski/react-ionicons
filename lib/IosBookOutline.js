...
var IosBookOutline = function (_Component) {
  _inherits(IosBookOutline, _Component);

  function IosBookOutline(props) {
    _classCallCheck(this, IosBookOutline);

    var _this = _possibleConstructorReturn(this, (IosBookOutline.__proto__ || Object.getPrototypeOf(IosBookOutline)).call(this, props));
