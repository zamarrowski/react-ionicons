...
var IosColorFill = function (_Component) {
  _inherits(IosColorFill, _Component);

  function IosColorFill(props) {
    _classCallCheck(this, IosColorFill);

    var _this = _possibleConstructorReturn(this, (IosColorFill.__proto__ || Object.getPrototypeOf(IosColorFill)).call(this, props));
