...
var IosOptions = function (_Component) {
  _inherits(IosOptions, _Component);

  function IosOptions(props) {
    _classCallCheck(this, IosOptions);

    var _this = _possibleConstructorReturn(this, (IosOptions.__proto__ || Object.getPrototypeOf(IosOptions)).call(this, props));
