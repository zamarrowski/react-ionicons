...
var MdMicrophone = function (_Component) {
  _inherits(MdMicrophone, _Component);

  function MdMicrophone(props) {
    _classCallCheck(this, MdMicrophone);

    var _this = _possibleConstructorReturn(this, (MdMicrophone.__proto__ || Object.getPrototypeOf(MdMicrophone)).call(this, props));
