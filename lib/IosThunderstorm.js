...
var IosThunderstorm = function (_Component) {
  _inherits(IosThunderstorm, _Component);

  function IosThunderstorm(props) {
    _classCallCheck(this, IosThunderstorm);

    var _this = _possibleConstructorReturn(this, (IosThunderstorm.__proto__ || Object.getPrototypeOf(IosThunderstorm)).call(this, props));
