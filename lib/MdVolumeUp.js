...
var MdVolumeUp = function (_Component) {
  _inherits(MdVolumeUp, _Component);

  function MdVolumeUp(props) {
    _classCallCheck(this, MdVolumeUp);

    var _this = _possibleConstructorReturn(this, (MdVolumeUp.__proto__ || Object.getPrototypeOf(MdVolumeUp)).call(this, props));
