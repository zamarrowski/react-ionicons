...
var IosHelp = function (_Component) {
  _inherits(IosHelp, _Component);

  function IosHelp(props) {
    _classCallCheck(this, IosHelp);

    var _this = _possibleConstructorReturn(this, (IosHelp.__proto__ || Object.getPrototypeOf(IosHelp)).call(this, props));
