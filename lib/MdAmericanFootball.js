...
var MdAmericanFootball = function (_Component) {
  _inherits(MdAmericanFootball, _Component);

  function MdAmericanFootball(props) {
    _classCallCheck(this, MdAmericanFootball);

    var _this = _possibleConstructorReturn(this, (MdAmericanFootball.__proto__ || Object.getPrototypeOf(MdAmericanFootball)).call(this, props));
  ...
  _createClass(MdAmericanFootball, [{
    key: 'render',
