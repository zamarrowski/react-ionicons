...
var IosJetOutline = function (_Component) {
  _inherits(IosJetOutline, _Component);

  function IosJetOutline(props) {
    _classCallCheck(this, IosJetOutline);

    var _this = _possibleConstructorReturn(this, (IosJetOutline.__proto__ || Object.getPrototypeOf(IosJetOutline)).call(this, props));
