...
var MdRefresh = function (_Component) {
  _inherits(MdRefresh, _Component);

  function MdRefresh(props) {
    _classCallCheck(this, MdRefresh);

    var _this = _possibleConstructorReturn(this, (MdRefresh.__proto__ || Object.getPrototypeOf(MdRefresh)).call(this, props));
