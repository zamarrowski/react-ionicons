...
var MdCall = function (_Component) {
  _inherits(MdCall, _Component);

  function MdCall(props) {
    _classCallCheck(this, MdCall);

    var _this = _possibleConstructorReturn(this, (MdCall.__proto__ || Object.getPrototypeOf(MdCall)).call(this, props));
