...
var MdIonic = function (_Component) {
  _inherits(MdIonic, _Component);

  function MdIonic(props) {
    _classCallCheck(this, MdIonic);

    var _this = _possibleConstructorReturn(this, (MdIonic.__proto__ || Object.getPrototypeOf(MdIonic)).call(this, props));
