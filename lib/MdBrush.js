...
var MdBrush = function (_Component) {
  _inherits(MdBrush, _Component);

  function MdBrush(props) {
    _classCallCheck(this, MdBrush);

    var _this = _possibleConstructorReturn(this, (MdBrush.__proto__ || Object.getPrototypeOf(MdBrush)).call(this, props));
