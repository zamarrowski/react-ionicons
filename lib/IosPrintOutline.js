...
var IosPrintOutline = function (_Component) {
  _inherits(IosPrintOutline, _Component);

  function IosPrintOutline(props) {
    _classCallCheck(this, IosPrintOutline);

    var _this = _possibleConstructorReturn(this, (IosPrintOutline.__proto__ || Object.getPrototypeOf(IosPrintOutline)).call(this, props));
