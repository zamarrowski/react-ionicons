...
var MdPhotos = function (_Component) {
  _inherits(MdPhotos, _Component);

  function MdPhotos(props) {
    _classCallCheck(this, MdPhotos);

    var _this = _possibleConstructorReturn(this, (MdPhotos.__proto__ || Object.getPrototypeOf(MdPhotos)).call(this, props));
