...
var MdOpen = function (_Component) {
  _inherits(MdOpen, _Component);

  function MdOpen(props) {
    _classCallCheck(this, MdOpen);

    var _this = _possibleConstructorReturn(this, (MdOpen.__proto__ || Object.getPrototypeOf(MdOpen)).call(this, props));
