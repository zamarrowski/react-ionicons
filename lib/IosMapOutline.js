...
var IosMapOutline = function (_Component) {
  _inherits(IosMapOutline, _Component);

  function IosMapOutline(props) {
    _classCallCheck(this, IosMapOutline);

    var _this = _possibleConstructorReturn(this, (IosMapOutline.__proto__ || Object.getPrototypeOf(IosMapOutline)).call(this, props));
