...
var MdArrowRoundForward = function (_Component) {
  _inherits(MdArrowRoundForward, _Component);

  function MdArrowRoundForward(props) {
    _classCallCheck(this, MdArrowRoundForward);

    var _this = _possibleConstructorReturn(this, (MdArrowRoundForward.__proto__ || Object.getPrototypeOf(MdArrowRoundForward)).call(this, props));
  ...
  _createClass(MdArrowRoundForward, [{
    key: 'render',
