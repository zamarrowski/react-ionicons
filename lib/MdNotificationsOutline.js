...
var MdNotificationsOutline = function (_Component) {
  _inherits(MdNotificationsOutline, _Component);

  function MdNotificationsOutline(props) {
    _classCallCheck(this, MdNotificationsOutline);

    var _this = _possibleConstructorReturn(this, (MdNotificationsOutline.__proto__ || Object.getPrototypeOf(MdNotificationsOutline)).call(this, props));
  ...
  _createClass(MdNotificationsOutline, [{
    key: 'render',
