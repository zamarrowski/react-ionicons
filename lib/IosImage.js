...
var IosImage = function (_Component) {
  _inherits(IosImage, _Component);

  function IosImage(props) {
    _classCallCheck(this, IosImage);

    var _this = _possibleConstructorReturn(this, (IosImage.__proto__ || Object.getPrototypeOf(IosImage)).call(this, props));
