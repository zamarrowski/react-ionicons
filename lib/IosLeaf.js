...
var IosLeaf = function (_Component) {
  _inherits(IosLeaf, _Component);

  function IosLeaf(props) {
    _classCallCheck(this, IosLeaf);

    var _this = _possibleConstructorReturn(this, (IosLeaf.__proto__ || Object.getPrototypeOf(IosLeaf)).call(this, props));
