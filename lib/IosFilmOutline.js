...
var IosFilmOutline = function (_Component) {
  _inherits(IosFilmOutline, _Component);

  function IosFilmOutline(props) {
    _classCallCheck(this, IosFilmOutline);

    var _this = _possibleConstructorReturn(this, (IosFilmOutline.__proto__ || Object.getPrototypeOf(IosFilmOutline)).call(this, props));
